...
namespace OpenDentBusiness
{
    ...
    public class Operatories
    {
        ...
        public static List<Tuple<Appointment, bool>> MergeApptCheck(long masterOpNum, List<long> listChildOpNums)
        {
            ...
            return listApptsAll.Where(x => x.Op != masterOpNum).Select(x => new Tuple<Appointment, bool>(x, HasConflict(x, listApptsAll))).ToList();
        }
