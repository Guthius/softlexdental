...
namespace OpenDentBusiness
{
    ...
    public class UserGroups
    {
        ...
        public static void Delete(UserGroup group)
        {
            ...
            if (Preferences.GetLong(PrefName.SecurityGroupForStudents) == group.UserGroupNum)
            {
            ...
            if (Preferences.GetLong(PrefName.SecurityGroupForInstructors) == group.UserGroupNum)
            {
