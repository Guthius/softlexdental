...
namespace OpenDentBusiness
{
    ...
    public class ProcButtons
    {
        ...
        private static void SetToDefaultMySQL()
        {
            ...
            //Amalgam
            autoCodeNum = AutoCode.GetNumFromDescript("Amalgam");
            if (autoCodeNum.HasValue)
            {
                ...
                command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + POut.Long(procButtonNum) + ",0,"
                    + POut.Long(autoCodeNum.Value) + ")";
                Db.NonQ(command);
            }
            //Composite
            autoCodeNum = AutoCode.GetNumFromDescript("Composite");
            if (autoCodeNum.HasValue)
            {
            ...
            //RCT
            autoCodeNum = AutoCode.GetNumFromDescript("Root Canal");
            if (autoCodeNum.HasValue)
            {
            ...
            //RCT BU PFM
            autoCodeNum = AutoCode.GetNumFromDescript("Root Canal");
            autoCodeNum2 = AutoCode.GetNumFromDescript("BU/P&C");
            if (autoCodeNum.HasValue || ProcedureCodes.IsValidCode("D2750"))
            {//we add this button if either RCT or crown is available.
                ...
                if (autoCodeNum2.HasValue)
                {
                    command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + POut.Long(procButtonNum) + ",0,"
                    + POut.Long(autoCodeNum2.Value) + ")";
                    Db.NonQ(command);
                }
            }
            //RCT BU Ceramic
            autoCodeNum = AutoCode.GetNumFromDescript("Root Canal");
            autoCodeNum2 = AutoCode.GetNumFromDescript("BU/P&C");
            if (autoCodeNum.HasValue || ProcedureCodes.IsValidCode("D2740"))
            {//we add this button if either RCT or crown is available.
            ...
            //Bridge-PFM
            autoCodeNum = AutoCode.GetNumFromDescript("PFM Bridge");
            if (autoCodeNum.HasValue || ProcedureCodes.IsValidCode("N4127"))
            {
            ...
            //Bridge-Ceramic
            autoCodeNum = AutoCode.GetNumFromDescript("Ceramic Bridge");
            ...
            //Build Up
            autoCodeNum = AutoCode.GetNumFromDescript("BU/P&C");
            if (autoCodeNum.HasValue)
            {
