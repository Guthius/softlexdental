    ...
    public class Statements
    {
        ...
        public static DataTable GetBilling(bool isSent, int orderBy, DateTime dateFrom, DateTime dateTo, List<long> clinicNums)
        {
            ...
            string command = "SELECT patient.BalTotal,BillingType,FName,patient.InsEst,statement.IsSent,"
                ...
                + "AND s2.IsSent=1 ";
            if (Preference.GetBool(PreferenceName.BillingIgnoreInPerson))
            {
            ...
            {
                row = table.NewRow();
                if (rawRow["SuperFamily"].ToString() == "0")
                ...
                row["billingType"] = Defs.GetName(DefinitionCategory.BillingTypes, PIn.Long(rawRow["BillingType"].ToString()));
                if (insEst == 0)
                {
                    row["insEst"] = "";
                }
        ...
        public static EmailMessage GetEmailMessageForStatement(Statement stmt, Patient pat)
        {
            if (stmt.PatNum != pat.PatNum)
            {
                ...
                SecurityLog.Write(stmt.PatNum, SecurityLogEvents.StatementPatNumMismatch, logMsg, SecurityLogSource.Diagnostic);
            }
            ...
            {//Subject was not set.  Set str to the default billing email subject.
                str = Preference.GetString(PreferenceName.BillingEmailSubject);
            }
        ...
        public static EmailMessage GetEmailMessageForPortalStatement(Statement stmt, Patient pat)
        {
            ...
            {//Body was not preset, set a body text.
                emailBody = Lans.g("Statements", "Dear") + " [nameFLnoPref],\r\n\r\n"
                    ...
                    + Lans.g("Statements", "1. Visit the following URL in a web browser:") + " " + Preference.GetString(PreferenceName.PatientPortalURL) + ".\r\n"
        ...
        public static string ReplaceVarsForSms(string smsTemplate, Patient pat, Statement stmt)
        {
            ...
            {
                officeName = Preference.GetString(PreferenceName.PracticeTitle);
            }
            ...
            , List<long> listAdjustments, List<long> listPayNums, List<long> listProcedures)
        {
            ...
            stmt.Intermingled = listPatNumsSelected.Count > 1 && Preference.GetBool(PreferenceName.IntermingleFamilyDefault);
