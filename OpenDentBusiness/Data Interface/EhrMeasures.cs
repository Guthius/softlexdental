            ...
            for (int i = 0; i < retVal.Count; i++)
            {
                ...
                switch (mu.MeasureType)
                {
                    ...
                    case EhrMeasureType.Smoking:
                        ...
                        if (pat.Age < 13)
                        {//The smoking measure does not apply to patients under the age of 13.
                            mu.Met = MuMet.NA;
                        }
                    ...
                    case EhrMeasureType.ClinicalSummaries:
                        ...
                        {
                            if (listProcs[p].ProcDate < DateTime.Now.AddYears(-1) || listProcs[p].ProcStatus != ProcStat.C)
            ...
            for (int i = 0; i < retVal.Count; i++)
            {
                ...
                switch (mu.MeasureType)
                {
                    ...
                    case EhrMeasureType.Reminders:
                        ...
                        {
                            if (listProcsRem[p].ProcDate < DateTime.Now.AddYears(-2) || listProcsRem[p].ProcStatus != ProcStat.C)
                            {//not within the last year or not a completed procedure
                                continue;
                            }
                    ...
                    case EhrMeasureType.SecureMessaging:
                        ...
                        {
                            if (listProcsMsg[p].ProcDate < DateTime.Now.AddYears(-1) || listProcsMsg[p].ProcStatus != ProcStat.C)
                            {//not within the last year or not a completed procedure
                                continue;
                            }
