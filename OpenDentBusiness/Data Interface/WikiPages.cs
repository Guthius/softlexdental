...
namespace OpenDentBusiness
{
    public class WikiPages
    {
        ...
        {
            return Db.GetScalar("SELECT PageTitle FROM wikipage WHERE PageTitle = '" + POut.String(pageTitle) + "' AND IsDraft=0");
        }
        ...
        /// <summary>
        /// Throws exceptions, surround with Try catch. Only delete wiki drafts with this function. Normal wiki pages cannot be deleted, only archived.
        /// </summary>
        ...
        /// <summary>
        /// Gets one WikiPage from the db.
        /// </summary>
        public static WikiPage GetOne(long wikiPageNum) => Crud.WikiPageCrud.SelectOne(wikiPageNum);
