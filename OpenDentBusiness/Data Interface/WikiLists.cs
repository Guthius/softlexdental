...
namespace OpenDentBusiness{
    ...
    public class WikiLists
    {
        ...
        public static void ShiftColumnRight(string listName, string colName)
        {
            ...
            || colName == columnNames.Rows[columnNames.Rows.Count - 1][0].ToString())
        ...
        public static List<string> GetAllLists()
        {
            ...
            {
                retVal.Add(row[0].ToString().Substring(9));
            }
            return retVal;
        }

        /// <summary>
        /// <para>Surround with try catch. Safely renames list by creating new list, selecting existing list into new list, then deleting existing list.</para>
