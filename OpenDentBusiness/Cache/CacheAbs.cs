...
namespace OpenDentBusiness
{
    ...
    public abstract class CacheAbs<T>
    {
        ...
        /// <summary>
        /// This method queries the database for the list of objects and return it. Remoting role does not need to be checked.
        /// </summary>
        ...
        /// <summary>
        /// Returns the main cache entity as a DataTable.  This is for middle tier purposes, see Cache.GetCacheDs() for details.
        /// </summary>
        ...
        /// <summary>
        /// Fills the cache using the specified source. If source is Database, then table can be null.
        /// </summary>
        private void FillCache(FillCacheSource source, DataTable table)
        {
            ...
            {
                allItems = GetCacheFromDb();
            }
            else if (source == FillCacheSource.DataTable)
            {
                allItems = TableToList(table);
            }

            OnNewCacheReceived(allItems);
        }

        /// <summary>
        /// Fills the cache using the provided DataTable.
        /// </summary>
        public void FillCacheFromTable(DataTable table) => FillCache(FillCacheSource.DataTable, table);
