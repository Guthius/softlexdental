        ...
        public static QualityMeasure GetEhrCqmData(QualityType2014 qtype, DateTime dateStart, DateTime dateEnd, long provNum)
        {
            ...
            switch (qtype)
            {
                ...
                case QualityType2014.WeightOver65:
                    ...
                    foreach (KeyValuePair<long, List<EhrCqmEncounter>> patNumListEncs in measureCur.DictPatNumListEncounters)
                    {//loop through every patient with an encounter list
                        ...
                        {//loop through encounter list for this patient
                            ...
                            {//loop through palliative care problem list for this patient\
                                if (listProbsCur[j].ValueSetOID != "2.16.840.1.113883.3.600.1.1579")
        ...
        private static List<EhrCqmPatient> GetEhrPatsFromEncsOrProcs(Dictionary<long, List<EhrCqmEncounter>> dictPatNumListEncounters, Dictionary<long, List<EhrCqmProc>> dictPatNumListProcs)
        {
            ...
            for (int i = 0; i < uniquePats.Length; i++)
            {
                ...
                if (payerTypeCur != null)
                {
                    ...
                    {
                        if (listEhrCodesForPayerTypeOID[j].CodeValue == payerTypeCur.SopCode)
            ...
            switch (qtype)
            {
                ...
                case QualityType2014.WeightOver65:
                    ...
                    for (int i = 0; i < alldata.ListEhrPats.Count; i++)
                    {
                        ...
                        for (int j = 0; j < listProbsCur.Count; j++)
                        {
                            if (listProbsCur[j].ValueSetOID == "2.16.840.1.113883.3.600.1.1623")
                ...
                case QualityType2014.Pneumonia:
                    ...
                    for (int i = 0; i < alldata.ListEhrPats.Count; i++)
                    {
                        ...
                        {
                            if (listMedPatsCur[j].ValueSetOID == "2.16.840.1.113883.3.464.1003.110.12.1027")
                        ...
                        {
                            if (listProcsCur[j].ValueSetOID == "2.16.840.1.113883.3.464.1003.110.12.1034")
                        ...
                        for (int j = 0; j < listProbsCur.Count; j++)
                        {
                            if (listProbsCur[j].ValueSetOID == "2.16.840.1.113883.3.464.1003.110.12.1028")
                ...
                case QualityType2014.TobaccoCessation:
                    ...
                    for (int i = 0; i < alldata.ListEhrPats.Count; i++)
                    {
                        ...
                        if (mostRecentAssessDate > DateTime.MinValue && mostRecentAssessValueSetOID == "2.16.840.1.113883.3.526.3.1189")
                        {//Non-User
                            alldata.ListEhrPats[i].IsNumerator = true;
                        ...
                        if (mostRecentAssessDate > DateTime.MinValue && mostRecentAssessValueSetOID == "2.16.840.1.113883.3.526.3.1170")
                        {//User
                        ...
                        else if (mostRecentAssessValueSetOID == "2.16.840.1.113883.3.526.3.1170")
                        {//User
                ...
                case QualityType2014.Influenza:
                    ...
                    for (int i = 0; i < alldata.ListEhrPats.Count; i++)
                    {
                        ...
                        {
                            if (listAllEncsCur[j].ValueSetOID != "2.16.840.1.113883.3.526.3.1252")
                        ...
                        for (int j = 0; j < listAllProcsCur.Count; j++)
                        {
                            if (listAllProcsCur[j].ValueSetOID != "2.16.840.1.113883.3.526.3.402")
                        ...
                        {
                            if (listAllProbsCur[j].ValueSetOID != "2.16.840.1.113883.3.526.3.1185")
                        ...
                        for (int j = 0; j < listAllProbsCur.Count; j++)
                        {
                            if (listAllProbsCur[j].ValueSetOID != "2.16.840.1.113883.3.526.3.1255")
                ...
                case QualityType2014.WeightChild_3_1:
                    ...
                    for (int i = 0; i < alldata.ListEhrPats.Count; i++)
                    {
                        ...
                        for (int j = 0; j < listProbsCur.Count; j++)
                        {
                            if (listProbsCur[j].ValueSetOID == "2.16.840.1.113883.3.526.3.378")
                ...
                case QualityType2014.BloodPressureManage:
                    ...
                    for (int i = 0; i < alldata.ListEhrPats.Count; i++)
                    {
                        ...
                        for (int j = 0; j < listProbsCur.Count; j++)
                        {
                            ...
                            if (listProbsCur[j].ValueSetOID == "2.16.840.1.113883.3.526.3.353")
                            ...
                            if (listProbsCur[j].ValueSetOID == "2.16.840.1.113883.3.526.3.1002")
                        ...
                        {
                            if (listEncountersCur[j].ValueSetOID == "2.16.840.1.113883.3.464.1003.109.12.1014")
...
BMI 18.5-25.";
        ...
        private static void GenerateQRDACatThree(List<QualityMeasure> listQMs, DateTime dateStart, DateTime dateEnd, string folderRoot)
        {
            ...
            using (_w = XmlWriter.Create(folderRoot + "\\QRDA_Category_III.xml", xmlSettings))
            {
                ...
                _w.WriteElementString("softwareName", "Open Dental version " + Preferences.GetString(PrefName.ProgramVersion));
                End("assignedAuthoringDevice");
                Start("representedOrganization");
                _w.WriteElementString("name", Preferences.GetString(PrefName.PracticeTitle));//Validated
                        ...
                        for (int j = 0; j < listPopCountDicts.Count; j++)
                        {
                            switch (j)
                            {
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    if (listQMs[measureIndx].eMeasureDenexId == "")
                                ...
                                case 3:
                                    ...
                                    break;
                                case 4:
                                    if (listQMs[measureIndx].eMeasureDenexcepId == "")
                            ...
                            {
                                if (kvpair.Key == "All" && kvpair.Value == 0)
                                ...
                                switch (kvpair.Key)
                                {
                                    ...
                                    default://All race and ethnicity measures
                                        Cdcrec cdcRec;
                                        if (!dictRaces.TryGetValue(kvpair.Key, out cdcRec))
                                        {//dictRaces's key is cdcrec.CdcrecCode
                                        ...
                                        {//Unexpected start to HierarchicalCode
        ...
        private static void GenerateQRDACatOne(List<QualityMeasure> listQMs, DateTime dateStart, DateTime dateEnd, string folderRoot)
        {
            ...
            for (int i = 0; i < listAllEhrPats.Count; i++)
            {
                ...
                using (_w = XmlWriter.Create(strBuilder, xmlSettings))
                {
                    ...
                    Start("assignedAuthoringDevice");
                    _w.WriteElementString("manufacturerModelName", "Open Dental version " + Preferences.GetString(PrefName.ProgramVersion));
                    ...
                    AddressUnitedStates(Preferences.GetString(PrefName.PracticeAddress), Preferences.GetString(PrefName.PracticeAddress2), Preferences.GetString(PrefName.PracticeCity), Preferences.GetString(PrefName.PracticeST), Preferences.GetString(PrefName.PracticeZip), "WP");//Validated
                    End("representedCustodianOrganization");
                    End("assignedCustodian");
                    End("custodian");
                    #endregion custodian
...
#endif
            for (int i = 0; i < listAllEMeasureNums.Count; i++)
            {//make a file for each of our 9 eMeasures
                using (ZipFile zipCur = new ZipFile())
                {
                    for (int j = 0; j < listAllEhrPats.Count; j++)
                    {//go through list of all unique patients that are in any of the IPPs
                        Patient patCur = listAllEhrPats[j].EhrCqmPat;
                        if (!dictPatNumXml.ContainsKey(patCur.PatNum))
                        {//just in case, every patient will be in the dictionary.  Dictionary links a PatNum key to the cat I QRDA xml string value
                            continue;
                        }
                        if (!dictPatNumListEMeasureNums.ContainsKey(patCur.PatNum))
                        {//just in case, every patient in listAllEhrPats will be in the dictionary linked to their eMeasureNums
                            continue;
                        }
        ...
        private static Dictionary<string, int> GetSupplementalCounts(List<EhrCqmPatient> listPats)
        {
            ...
            for (int i = 0; i < listPats.Count; i++)
            {
                ...
                {
                    switch (listPats[i].PayorSopCode.Substring(0, 1))
        ...
        private static string ValidateSettings()
        {
            ...
            if (Preferences.GetString(PrefName.PracticeZip).Trim().Length < 5)
            {
                if (strErrors != "")
                {
                    strErrors += "\r\n";
