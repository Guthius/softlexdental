...
namespace OpenDentBusiness
{
    public class Plugin
    {
        public static void Trigger(object sender, string trigger, params object[] args)
        {
    ...
    {
        /// <summary>
        /// Lock object specifically for _listPlugins.
        /// </summary>
        private static ReaderWriterLockSlim _lock = new ReaderWriterLockSlim();

        /// <summary>
        /// Do not directly reference this variable, use ListPlugins instead.
        /// </summary>
        ...
        private static List<PluginContainer> ListPlugins
        {
            get
            {
                ...
                // TODO: Should we load plugins at this time???
            ...
            foreach (Program program in Programs.GetWhere(x => x.Enabled && !string.IsNullOrEmpty(x.PluginDllName)))
            {
                ...
                if (dllPath.Contains("[VersionMajMin]"))
                {
                    ...
                    else
                    {
                        ...
                        {//must have an AtoZ folder to check
