...
namespace OpenDentBusiness
{
    ...
    {
        /// <summary>
        /// ONLY USED FOR PREF-BOUND UI ELEMENTS.
        /// </summary>
        ...
        /// </summary>
        [Obsolete("Deprecated in version 17.4.40.")]
        ...
        /// that aging calculations have started and prevents another 
        /// connection from running simultaneously.  In order to run aging, 
        /// this will have to be cleared, either by the connection that set the 
        /// flag when aging finishes, or by the user overriding the lock and 
        ...
        [Obsolete] VoiceMailDeleteAfterDays,
        ...
        [Obsolete] VoiceMailMonitorHeartBeat,
        ...
        [Obsolete] VoiceMailOriginationPath,
        ...
        [Obsolete] VoiceMailSMB2Password,
        ...
        [Obsolete] VoiceMailSMB2UserName,
        ...
        /// <summary>
        /// Boolean. 0 by default. True when Web Sched service is enabled. 
        /// The eConnector keeps this preference current with OD HQ, calling our web service to verify active service is still required.
        /// </summary>
        WebSchedService,
        ...
        /// <summary>
        /// If enabled, allows users to right click on ODTextboxes or ODGrids to populate the context menu with any detected wiki links.
        /// </summary>
        WikiDetectLinks,
        
        /// <summary>
        /// If enabled, allows users to create new wiki pages when following links from textboxes and grids. (Disable to prevent proliferation of misspelled wiki pages.)
        /// </summary>
