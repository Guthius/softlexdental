...
namespace OpenDentBusiness
{
    public class SheetsInternal
    {
        ...
        /// <summary>
        ///     <para>
        ///         Sets the value of all fields of type <see cref="SheetFieldType.PatImage"/>, 
        ///         that are part of the specified sheet definition to the ID of the
        ///         <see cref="Definition"/> that represents patient images.
        ///     </para>
        ///     <para>
        ///         Defaults to using the ID of the first image category definition if no category 
        ///         has been configured for patient images.
        ///     </para>
        ///     <para>
        ...
        {
            var imageCategories = Definition.GetByCategory(DefinitionCategory.ImageCats);

            var definition = 
                imageCategories.FirstOrDefault(x => x.Value.Contains("P")) ?? 
                imageCategories.FirstOrDefault();

            var definitionId = definition?.Id ?? 0;
            ...
            foreach (var sheetFieldDef in sheetDef.SheetFieldDefs)
            {
                ...
                sheetFieldDef.FieldName = definitionId.ToString();
            }
        }
...
* Treatment plans may change, and I will be responsible for the work actually done.", sheet.FontSize, sheet.FontName, false, 92, 167 + yOffset, 670, 155));
        ...
        public static SheetDef GetSheetDef(SheetTypeEnum sheetType) => GetSheetDef(GetInternalType(sheetType));
    }
}
