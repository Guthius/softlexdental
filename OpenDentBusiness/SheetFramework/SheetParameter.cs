...
namespace OpenDentBusiness
{
    public class SheetParameter
    {
        ...
        /// <summary>
        /// This is the value which must be set in order to obtain data from the database. It is 
        /// usually an int primary key. If running a batch, this may be an array of int.
        /// </summary>
        public object ParamValue;

        public SheetParameter Copy() => (SheetParameter)MemberwiseClone();
        ...
        {
            foreach (var sheetParameter in parameters)
            {
