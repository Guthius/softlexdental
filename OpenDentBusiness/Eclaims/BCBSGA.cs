...
{
    public static class BCBSGA
    {
        public static string ErrorMessage = "";

        /// <summary>
        /// Returns true if the communications were successful, and false if they failed. If they 
        /// failed, a rollback will happen automatically by deleting the previously created X12 
        /// file. The batchnum is supplied for the possible rollback.
        /// </summary>
