...
namespace OpenDentBusiness
{
    ...
    {
        /// <summary>
        /// Returns a message string used to place a patient or guarantor account with TSI for collection.
        /// </summary>
        ...
        /// 4=other
        /// 
        /// Defaults to 4 - other if not able to determine pat relationship to guar.
        /// </summary>
        ...
        /// <summary>
        /// Returns display name of 3 letter language abbr or custom language name if not found.  Will return empty string, not null.
        /// </summary>
        private static string gGetLanguageString(string language)
        {
            CultureInfo cultureInfo = MiscUtils.GetCultureFromThreeLetter(language);
