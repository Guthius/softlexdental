...
namespace OpenDentBusiness
{
    public class ItransNCpl
    {
        ...
        /// <summary>
        /// BINs is provided for retrieval of all outstanding response transactions.
        /// Making a type 04 request to each of the supplied BINs will ensure that all outstanding mailboxes are cleared.
        /// </summary>
        ...
        /// <summary>
        /// Returns a blank string if there were no errors while attempting to update internal carriers using iTrans n-cpl.json file.
        /// </summary>
        public static string TryCarrierUpdate(bool isAutomatic = true, ItransImportFields fieldsToImport = ItransImportFields.None)
        {
            ...
            if (clearinghouse.CommBridge == EclaimsCommBridge.ITRANS && !string.IsNullOrEmpty(clearinghouse.ResponsePath))
            {
                ...
                if (isAutomatic && Preference.GetString(PreferenceName.WebServiceServerName).ToLower() != Dns.GetHostName().ToLower())
            ...
            {//ITRANS2 not used or not setup correctly, go to HQ for file content.
             //try {
            ...
            foreach (ItransNCpl.Carrier jsonCarrier in iTransNCpl.ListCarriers)
            {//Update carriers.
                ...
                {//Some Canadian carriers share ElectId, need to filter further.  This happens with carrier resellers.
                    ...
                    if (listPhoneMatchedDbCarriers.Count != 1)
                ...
                if (carrierInDb == null)
                {//Carrier can not be matched to internal Carrier based on ElectID.
                    ...
                    carrierNew.Phone = jsonCarrierPhone;
            ...
            foreach (ItransImportFields field in listFields)
            {
                ...
                switch (field)
                {
                    case ItransImportFields.Phone:
                        odCarrier.Phone = jsonCarrierPhone;
                        break;
        ...
        public enum EnumNXYZ
        {
            ...
            /// <summary>
            /// Only blue on blue, same carrier (primary and secondary).
            ...
            /// thus can only trigger this scenraio by sending primray claim.
            /// </summary>
            Z
        }
