...
namespace OpenDentBusiness
{
    ...
    {
        ///<summary>ONLY USED FOR PREF-BOUND UI ELEMENTS.</summary>
        ...
        public static bool Update(this PrefName prefName, object value)
        {
            switch (prefName.GetValueType())
            {
                ...
                case PrefValueType.BOOL:
                    return Prefs.UpdateBool(prefName, (bool)value);
                ...
                case PrefValueType.DOUBLE:
                    return Prefs.UpdateDouble(prefName, (double)value);
