...
namespace OpenDentBusiness
{
    ...
    /// <summary>
    /// Transworld Systems Inc (TSI) transaction log.
    /// Logs communication between the Open Dental program and TSI. 
    /// Entries contain information about accounts placed with TSI, payments or adjustments to accounts placed, or 
    /// transactions to Suspend, Reinstate or Cancel accounts.
    /// </summary>
    public class TsiTransLog
    {
    ...
    public enum TsiTransType
    {
        ...
        [Description("Suspend")]
        SS,
        ///<summary>To differentiate aggregate rows from rows linked to transactions in the OD db.</summary>
