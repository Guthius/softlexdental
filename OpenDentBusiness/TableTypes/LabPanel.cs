...
{
    /// <summary>
    /// One lab panel comes back from the lab with multiple lab results. 
    /// Multiple panels can come back in one HL7 message. 
    /// This table loosely corresponds to the OBR segment.
    /// </summary>
