...
{
    /// <summary>
    /// This is a list of phrases that need to be translated. 
    /// The primary key is a combination of the ClassType and the English phrase. 
    ...
    public class Language : TableBase
    {
        ...
        /// <summary>
        /// As this gets more sophisticated, we will use this field to mark some phrases obsolete instead of just deleting them outright.  
        /// That way, translators will still have access to them.  For now, this is not used at all.
        /// </summary>
