namespace OpenDentBusiness
{
    ...
    public class TerminalActive
    {
        ...
        /// <summary>
        /// The ID of the session from which this terminal instance was started. 
        /// The session ID is unique per computer login, so if this is a terminal server every remote connection will have a unique session ID. 
        /// A kiosk is identified by ComputerName+SessionId+ProcessId.
        /// </summary>
        public int SessionId;

        /// <summary>
        /// The ID of the process that initiated this kiosk instance. 
        /// This is unique per active computer process, so if a row exists with a ProcessId that matches the instance we're about to start, we know 
        /// it is safe to delete it, it must be left over and needs cleaned up.
        /// </summary>
