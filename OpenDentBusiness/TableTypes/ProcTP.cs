...
{
    /// <summary>
    /// These are copies of procedures that are attached to saved treatment plans. 
    /// The ProcNumOrig points to the actual procedurelog row.
    /// </summary>
    
    public class ProcTP // TODO: [ODTable(IsSecurityStamped =true)] implement IsSecurityStamped as a interface??
    {
