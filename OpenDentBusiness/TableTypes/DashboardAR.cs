...
{
    /// <summary>
    /// A table just used by the dashboard to store historical AR because it never changes and it 
    /// takes too long (1 second for each of the 12 dates) to compute on the fly. One entry per 
    /// month going back at least 12 months. This table gets automatically filled the first time 
    /// that the dashboard is used. The most recent month also gets added by using the dashboard.
    /// </summary>
