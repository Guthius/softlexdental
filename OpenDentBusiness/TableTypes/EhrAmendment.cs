...
namespace OpenDentBusiness
{
    /// <summary>
    /// Used in EHR only. 
    /// Stores an entry indicating whether the office has accepted or denied the amendment. 
    /// Amendments can be verbal or written requests to add information to the patient's record. 
    /// The provider can either scan / import the document or create a detailed description that indicates what was verbally requested or where the document can be found.
    /// </summary>
