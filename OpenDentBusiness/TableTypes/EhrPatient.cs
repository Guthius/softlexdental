...
{
    /// <summary>
    /// Patient information needed for EHR. 
    /// 1:1 relation to patient table. 
    /// They are stored here because we want to try to keep the size of the patient table a bit smaller.
    /// </summary>
