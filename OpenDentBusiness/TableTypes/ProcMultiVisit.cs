...
{
    /// <summary>
    /// The procedure "In Process" status is a derived status in the UI based on the existence of a link between procedures in this table.
    /// </summary>
    public class ProcMultiVisit
    {
