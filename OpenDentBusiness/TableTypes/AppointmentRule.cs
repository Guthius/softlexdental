...
{
    /// <summary>
    /// For now, the rule is simple. It simply blocks all double booking of the specified code 
    /// range. The double booking would have to be for the same provider. This can later be 
