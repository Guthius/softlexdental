...
{
    /// <summary>
    /// Holds one recorded cell value for a tooth grid, which is a special kind of sheet field type
    /// that shows a grid with 32 rows and configurable columns.  The entire grid is a single large
    /// sheet field.
    /// </summary>
