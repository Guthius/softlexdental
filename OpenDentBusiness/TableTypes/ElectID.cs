...
{
    /// <summary>
    /// Corresponds to the electid table in the database. Helps with entering elecronic/payor id's 
    /// as well as keeping track of the specific carrier requirements. Only used by the X12 format.
    /// </summary>
