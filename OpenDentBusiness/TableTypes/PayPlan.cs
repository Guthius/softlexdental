...
namespace OpenDentBusiness
{
    ...
    public class PayPlan
    {
        ...
        /// <summary>
        /// The encrypted and bound signature in base64 format.
        /// The signature is bound to the concatenation of the Total Amount,APR,Number of Payments,Payment Amount
        /// </summary>
