...
{
    /// <summary>
    /// These are always attached to a mount and are constant.
    /// Should not be deleted, but rather updated if geometry changes. 
    /// Documents are then attached to MountItems using Document.MountItemNum field.
    /// </summary>
