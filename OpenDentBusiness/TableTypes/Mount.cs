...
{
    /// <summary>
    /// A mount shows in the images module just like other images in the tree. 
    /// But it is just a container for images within it rather than an actual image itself.
    /// </summary>
    public class Mount // TODO: Rename this? Mount seems much to general a name for what is essentially a list of images.
    {
