...
{
    /// <summary>
    /// Defines the columns present in a tooth grid, which is a special kind of sheet field def 
    /// that shows a grid with 32 rows and configurable columns. Can be edited without damaging any
    /// completed sheets.
    /// </summary>
