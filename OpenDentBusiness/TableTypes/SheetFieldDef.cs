...
namespace OpenDentBusiness{
	...
	public class SheetFieldDef:ODTable {
		...
		[XmlIgnore]
		[JsonIgnore]
		public bool IsMobileFieldType {
			get {
				//Always include these FieldTypes
				return this.FieldType.In
				(
				...
				|| (this.FieldType==SheetFieldType.StaticText && this.TabOrderMobile>=1)
				//checkMed checkboxes are ignored. All other checkboxes are included.
				|| (this.FieldType==SheetFieldType.CheckBox && !this.FieldName.StartsWith("checkMed"));
			}
		}
		...
		public static SheetFieldDef NewMobileHeader(string uiLabelMobile) {
			SheetFieldDef retVal=new SheetFieldDef(SheetFieldType.MobileHeader,"misc","",8.5f,"",false,
				0,0,0,0,GrowthBehaviorEnum.DownGlobal,"");
