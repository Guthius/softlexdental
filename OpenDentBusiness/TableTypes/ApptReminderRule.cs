...
namespace OpenDentBusiness
{
    ...
    {
        /// <summary>
        /// Use text OR email based on patient preference.
        /// </summary>
        Preferred = 0,

        /// <summary>
        /// Attempt to send text message, if successful do not send via email. (Unless, a SendAll 
        /// bool is used, which usually negates the need for this enumeration.)
        /// </summary>
        Text = 1,

        /// <summary>
        /// Attempt to send email message, if successful do not send via text. (Unless, a SendAll 
        /// bool is used, which usually negates the need for this enumeration.)
        /// </summary>
        Email = 2
    }
