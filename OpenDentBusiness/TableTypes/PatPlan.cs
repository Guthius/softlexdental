...
{
    /// <summary>
    /// Each row represents the linking of one insplan to one patient for current coverage. 
    /// Dropping a plan will delete the entry in this table. 
    /// Deleting a plan will delete the actual insplan (if no dependencies).
    /// </summary>
