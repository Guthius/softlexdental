...
namespace OpenDentBusiness.HL7
{
    ...
    public class EhrADT_A01
    {
        ...
        private void InitializeVariables()
        {
            ...
            if (_appt.ClinicNum != 0)
            {//Using clinics and a clinic is assigned.
                Clinic clinic = Clinic.GetById(_appt.ClinicNum);
        ...
        private void PID()
        {
            ...
            for (int i = 0; i < listPatientRaces.Count; i++)
            {
                ...
                {
                    if (listPatientRaces[i].CdcrecCode == "2186-5")
                    {//Not hispanic
        ...
        public static string Validate(Appointment appt)
        {
            ...
            for (int i = 0; i < listObservations.Count; i++)
            {
                ...
                else if (obs.ValType == EhrAptObsType.Numeric && obs.UcumCode != "")
