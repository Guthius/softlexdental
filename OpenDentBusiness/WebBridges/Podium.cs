...
{
    /// <summary>
    /// RESTful bridge to podium service. Without using REST Sharp or JSON libraries this code 
    /// might not work properly.
    /// </summary>
    public class Podium
    {
        /**
         * TODO: Refactor this as a seperate plugin.
         */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Podium"/> class.
        /// </summary>
        public Podium()
        {
        }
        ...
        /// <summary>
        /// The main logic that sends Podium invitations.
        /// </summary>
        public static void ThreadPodiumSendInvitations()
        {
            //var program = Program.GetByType<Podium>();
        ...
        //    if (pat.TxtMsgOk == YN.No || (pat.TxtMsgOk == YN.Unknown && Preference.GetBool(PreferenceName.TextMsgOkStatusTreatAsNo)))
        //    {//Don't text
        //     //Try to use email
