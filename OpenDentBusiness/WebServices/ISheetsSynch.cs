...
{
    /// <summary>
    /// This interface needs to have all web methods from SheetSynch that you want to use. 
    /// This allows for testing code without having to have an instance of the web service running.
    /// </summary>
