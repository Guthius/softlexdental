...
namespace UnitTests {
	...
	public class BenefitsTest:TestBase {
		...
		public void Benefits_BitewingFrequency() {
			...
			Patient pat=PatientT.CreatePatient(suffix);
			InsuranceInfo ins=InsuranceT.AddInsurance(pat,suffix);
			ins.ListBenefits.Add(BenefitT.CreateCategoryPercent(ins.PrimaryInsPlan.PlanNum,EbenefitCategory.Diagnostic,100));
			ins.ListBenefits.Add(BenefitT.CreateFrequencyProc(ins.PrimaryInsPlan.PlanNum,"D0274",BenefitQuantity.NumberOfServices,1,
		...
		public void Benefits_CancelScreeningFrequency() {
			...
			InsuranceInfo ins=InsuranceT.AddInsurance(pat,suffix);
			ins.ListBenefits.Add(BenefitT.CreateCategoryPercent(ins.PrimaryInsPlan.PlanNum,EbenefitCategory.Diagnostic,100));
			ins.ListBenefits.Add(BenefitT.CreateFrequencyProc(ins.PrimaryInsPlan.PlanNum,"D0431",BenefitQuantity.NumberOfServices,1,
		...
		public void Benefits_CrownsFrequency() {
			...
			Patient pat=PatientT.CreatePatient(suffix);
			InsuranceInfo ins=InsuranceT.AddInsurance(pat,suffix);
			ins.ListBenefits.Add(BenefitT.CreateCategoryPercent(ins.PrimaryInsPlan.PlanNum,EbenefitCategory.Crowns,100));
			ins.ListBenefits.Add(BenefitT.CreateFrequencyProc(ins.PrimaryInsPlan.PlanNum,"D2740",BenefitQuantity.NumberOfServices,1,
		...
		public void Benefits_SRPFrequency() {
			...
			Patient pat=PatientT.CreatePatient(suffix);
			InsuranceInfo ins=InsuranceT.AddInsurance(pat,suffix);
			ins.ListBenefits.Add(BenefitT.CreateCategoryPercent(ins.PrimaryInsPlan.PlanNum,EbenefitCategory.Periodontics,100));
			ins.ListBenefits.Add(BenefitT.CreateFrequencyProc(ins.PrimaryInsPlan.PlanNum,"D4341",BenefitQuantity.NumberOfServices,1,
		...
		public void Benefits_SealantAgeLimit() {
			...
			InsuranceInfo ins=InsuranceT.AddInsurance(pat,suffix);
			ins.ListBenefits.Add(BenefitT.CreateCategoryPercent(ins.PrimaryInsPlan.PlanNum,EbenefitCategory.RoutinePreventive,100));
			ins.ListBenefits.Add(BenefitT.CreateAgeLimitation(ins.PrimaryInsPlan.PlanNum,EbenefitCategory.None,12,
		...
		public void Benefits_BitewingFrequencyCanada() {
			...
			try {
				...
				InsuranceInfo ins=InsuranceT.AddInsurance(pat,suffix);
				ins.ListBenefits.Add(BenefitT.CreateCategoryPercent(ins.PrimaryInsPlan.PlanNum,EbenefitCategory.Diagnostic,100));
				ins.ListBenefits.Add(BenefitT.CreateFrequencyProc(ins.PrimaryInsPlan.PlanNum,"02144",BenefitQuantity.NumberOfServices,1,
					BenefitTimePeriod.CalendarYear));//One BW per year
		...
		public void Benefits_BitewingFrequencyPastYear() {
			...
			InsuranceInfo ins=InsuranceT.AddInsurance(pat,suffix);
			ins.ListBenefits.Add(BenefitT.CreateCategoryPercent(ins.PrimaryInsPlan.PlanNum,EbenefitCategory.Diagnostic,100));
			ins.ListBenefits.Add(BenefitT.CreateFrequencyProc(ins.PrimaryInsPlan.PlanNum,"D0274",BenefitQuantity.Months,12,
		...
		public void Benefits_TwoReceivedClaimProcsForSameClaim_FrequencyNotMet() {
			...
			InsuranceInfo ins=InsuranceT.AddInsurance(pat,suffix);
			ins.ListBenefits.Add(BenefitT.CreateCategoryPercent(ins.PrimaryInsPlan.PlanNum,EbenefitCategory.Diagnostic,100));
			ins.ListBenefits.Add(BenefitT.CreateFrequencyLimitation("D0274",2,BenefitQuantity.NumberOfServices,ins.PrimaryInsPlan.PlanNum,
		...
		public void Benefits_ServiceYear_FrequencyMet() {
			...
			//Add first procedure for the patient
			Procedure proc1=ProcedureT.CreateProcedure(pat,"D0274",ProcStat.EC,"",100,new DateTime(2018,6,1));
			...
			ClaimProcT.AddInsPaid(pat.PatNum,ins.ListInsPlans.FirstOrDefault().PlanNum,proc1.ProcNum,100,
				ins.ListInsSubs.FirstOrDefault().InsSubNum,0,0,new DateTime(2018,6,1));
			//Create second procedure
			Procedure proc2=ProcedureT.CreateProcedure(pat,"D0274",ProcStat.EC,"",100,new DateTime(2018,7,1));
			...
			ClaimProcT.AddInsPaid(pat.PatNum,ins.ListInsPlans.FirstOrDefault().PlanNum,proc2.ProcNum,100,
				ins.ListInsSubs.FirstOrDefault().InsSubNum,0,0,new DateTime(2018,7,1));
			//Create third procedure
			Procedure proc3=ProcedureT.CreateProcedure(pat,"D0274",ProcStat.EC,"",100,new DateTime(2019,1,1));
			List<ClaimProc> listClaimProcs=new List<ClaimProc> { };
		...
		public void Benefits_InsHistExamFrequency() {
			...
			InsuranceInfo ins=InsuranceT.AddInsurance(pat,suffix);
			ins.ListBenefits.Add(BenefitT.CreateCategoryPercent(ins.PrimaryInsPlan.PlanNum,EbenefitCategory.Diagnostic,100));
			ins.ListBenefits.Add(BenefitT.CreateFrequencyProc(ins.PrimaryInsPlan.PlanNum,"D0120",BenefitQuantity.NumberOfServices,1,
		...
		public void Benefits_InsHistProphyFrequency() {
			...
			InsuranceInfo ins=InsuranceT.AddInsurance(pat,suffix);
			ins.ListBenefits.Add(BenefitT.CreateCategoryPercent(ins.PrimaryInsPlan.PlanNum,EbenefitCategory.Diagnostic,100));
			ins.ListBenefits.Add(BenefitT.CreateFrequencyProc(ins.PrimaryInsPlan.PlanNum,"D1110",BenefitQuantity.NumberOfServices,1,
				BenefitTimePeriod.CalendarYear));//One Exam per year
