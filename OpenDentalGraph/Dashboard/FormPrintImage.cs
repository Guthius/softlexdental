...
namespace OpenDentalGraph
{
    public partial class FormPrintImage : Form
    {
        ...
        private Rectangle PageDimensions =>
            new Rectangle(0, 0, printDocument1.DefaultPageSettings.Bounds.Width, printDocument1.DefaultPageSettings.Bounds.Height);

        /// <summary>
        /// Dictionary of charts to get converted to a bmp. 
        /// It would be great if this could be replaced with sheets sometime in the future.
        /// </summary>
