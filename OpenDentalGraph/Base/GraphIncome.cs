...
namespace OpenDentalGraph
{
    public partial class GraphIncome : UserControl
    {
        ...
        public Dictionary<DateTime, double> FormattedData { get; private set; } = new Dictionary<DateTime, double>();
        ...
        private void chart1_AxisViewChanged(object sender, ViewEventArgs e) => UpdateIntervals();
        ...
        private void numberDailyLabelDensity_ValueChanged(object sender, EventArgs e) => UpdateIntervals();

        private void dateTimeFilter_ValueChanged(object sender, EventArgs e) => FilterData();
    }
}
