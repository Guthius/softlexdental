...
{
    /// <summary>
    /// Must be implemented in order to facilitate printing from dashboard.
    /// </summary>
    ...
    /// <summary>
    /// Legend Items have their own unique class.
    /// ODGraphLegendItems can be clicked to disable/re-enable their series' in the graph.
    /// </summary>
    public class ODGraphLegendItem
    {
        ...
        /// <summary>
        /// Called to filter the legend and chart when the user disables or re-enables this <see cref="ODGraphLegendItem"/>.
        /// </summary>
        public void Filter()
        {
        ...
        public ODGraphLegendItem() => ID = _idCounter++;
    }
...
namespace OpenDentalGraph.Enumerations
{
    ...
    [Obsolete] public enum ConfirmationGraphType
    {
        ByReason,
        ByResponseTime
    }
