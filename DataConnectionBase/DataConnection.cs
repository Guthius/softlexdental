...
namespace DataConnectionBase
{
    public class DataConnection : IDisposable
    {
        ...
        /// <summary>
        /// Instantiates a new MySQL database connection utilizing the current static connection variables.
        /// </summary>
        public DataConnection() : this(false) { }

        /// <summary>
        /// Instantiates a new MySQL database connection utilizing the current static connection variables.
        /// Uses MysqlUserLow and MysqlPassLow if isLow is set to true as to connect with the user with less permissions.
        /// </summary>
        public DataConnection(bool isLow)
            : this(ConnectionString, ServerName, Database, MysqlUser, MysqlPass, MysqlUserLow, MysqlPassLow, isLow)
        {
        }

        /// <summary>
        /// Instantiates a new database connection utilizing the current static connection variables except for the database.
        ...
        /// A safer and better paradigm for switching database context would be to spawn a new thread and utilize SetDbT().
        /// </summary>
        public DataConnection(string database)
            : this(ServerName, database, MysqlUser, MysqlPass)
        {
        }

        /// <summary>
        /// Instantiates a new database connection utilizing the connection variables passed in.
        /// </summary>
        ...
        public DataConnection(string connectStr, string serverName, string database, string mysqlUser, string mysqlPass)
            : this(connectStr, serverName, database, mysqlUser, mysqlPass, "", "", false)
        {
        }
        ...
        public DataConnection(string connectStr, string serverName, string database, string mysqlUser, string mysqlPass, string mysqlUserLow, string mysqlPassLow, bool isLow)
        {
            ...
            if (ODThread.SetDatabaseContextChild == null)
            {
                ...
                ODThread.SetDatabaseContextChild = (databaseContext) =>
                {
                    ...
                    {
                        dataConn.SetDbT((string)databaseContext, "", true);
                    }
                };
            }
            #endregion
        ...
        public static string BuildSimpleConnectionString(string pServer, string pDatabase, string pUserID, string pPassword)
        {
        ...
        {
            return BuildSimpleConnectionString(ServerName, Database, MysqlUserLow, MysqlPassLow);
        }
        ...
        public void SetDb(string server, string db, string user, string password, string userLow, string passLow, bool skipValidation)
        {
            ...
            TestConnection(connectStr, connectStrLow, skipValidation);
        ...
        ///<summary>This needs to be run every time we switch databases, especially on startup.  Will throw an exception if fails.  Calling class should catch exception.</summary>
        public void SetDb(string connectStr, string connectStrLow, bool skipValidation)
        {
            TestConnection(connectStr, connectStrLow, skipValidation);
        ...
        ///<summary></summary>
        public void SetDb(string connectStr, string connectStrLow)
        {
            SetDb(connectStr, connectStrLow, false);
        }
        ...
        public void SetDbT(string server, string db, string user, string password, string userLow, string passLow)
        {
            SetDbT(server, db, user, password, userLow, passLow, false);
        }
        ...
        public void SetDbT(string server, string db, string user, string password, string userLow, string passLow, bool skipValidation)
        {
            string connectStr = BuildSimpleConnectionString(server, db, user, password);
            string connectStrLow = "";
            if (userLow != "")
        ...
        public void SetDbT(string connectStr, string connectStrLow, bool skipValidation, bool skipTestConnection = false)
        {
        ...
        public void SetDbT(string connectStr, string connectStrLow)
        {
            SetDbT(connectStr, connectStrLow, false);
        }

        #endregion

        private void TestConnection(string connectStr, string connectStrLow, bool skipValidation)
        {
            _con = new MySqlConnection(connectStr);
            _cmd = new MySqlCommand();
            _cmd.Connection = _con;
        ...
        public MySqlCommand GetCommand() => _cmd;
        ...
        public void Execute(QueryAction queryAction)
        {
            if (queryAction != null)
            {
                RunMySqlAction(() => queryAction(_con));
            }
        }
        ...
        private bool StartConnectionErrorRetry(string connectionString, DataConnectionEventType errorType)
        {
            ...
            ODThread threadRetry = new ODThread(500, (o) =>
            {
                ...
                try
                {
                    using (DataConnection dconn = new DataConnection())
                    {
                        dconn.TestConnection(connectionString, "", skipValidation: false);
                    }
