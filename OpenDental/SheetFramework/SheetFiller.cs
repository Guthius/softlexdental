...
namespace OpenDental
{
    public class SheetFiller
    {
        ...
        ///Returns empty string if no errores were encountered.</summary>
        ...
        private static void FillFieldsInStaticText(Sheet sheet, Patient pat, Family fam = null)
        {
            ...
            if (pat != null)
            {
                ...
                for (int i = 0; i < proceduresList.Count; i++)
                {
                    ...
                    if (listIntraoralAndBiteWings.Contains(proc.CodeNum) && proc.ProcDate > dBW)
                    { //newest
                        dBW = proc.ProcDate;
                ...
                {
                    if (listRecalls[i].DateDue > DateTime.Today)
                    { //don't care about recalls in the future.
                        continue;
                    }
                ...
                Clinic clinicCur = Clinic.GetById(Clinics.ClinicId);
                if (clinicCur == null)
                {
            ...
            foreach (SheetField field in sheet.SheetFields)
            {
                switch (field.FieldName)
                {
                    ...
                    case "returnAddress":
                        ...
                        if (Clinic.GetById(patGuar.ClinicNum) != null)
                        {
                ...
                switch (field.FieldName)
                {
                    ...
                    case "medlab.obsTests":
                        ...
                        for (int i = 0; i < listMedLabs.Count; i++)
                        {
                            ...
                            if (listMedLabs[i].ActionCode == ResultAction.G)
                            {//"G" indicates a reflex test, not a test originally ordered, so skip these
                                continue;
                            }
                    ...
                    case "medlab.provNameLF":
                        ...
                        for (int i = 0; i < listMedLabs.Count; i++)
                        {
                            if (listMedLabs[i].OrderingProvFName == "" && listMedLabs[i].OrderingProvLName == "")
                            {//both names missing, continue
                                continue;
                            }
                            provFName = listMedLabs[i].OrderingProvFName;
                            provLName = listMedLabs[i].OrderingProvLName;
                            if (provFName != "" && provLName != "")
                            {//if both first and last name are included, use the values from this medlab
                                break;
                            }
                        }
                        if (provLName != "")
                ...
                switch (field.FieldName)
                {
                    ...
                    case "prov.dEANum":
                        if (dictRxs.ContainsKey(1))
                        {
                            ...
                            {
                                ProviderClinic provClinicCur = ProviderClinic.GetByProviderAndClinic(dictRxs[1].ProvNum, dictRxs[1].ClinicNum);
                    ...
                    case "prov.dEANum2":
                        if (dictRxs.ContainsKey(2))
                        {
                            ...
                            {
                                ProviderClinic provClinicCur = ProviderClinic.GetByProviderAndClinic(dictRxs[2].ProvNum, dictRxs[2].ClinicNum);
                                field.FieldValue = (provClinicCur == null ? "" : provClinicCur.DEANum);
                            }
                            else
                            {
                    ...
                    case "prov.dEANum3":
                        if (dictRxs.ContainsKey(3))
                        {
                            ...
                            {
                                ProviderClinic provClinicCur = ProviderClinic.GetByProviderAndClinic(dictRxs[3].ProvNum, dictRxs[3].ClinicNum);
                                field.FieldValue = (provClinicCur == null ? "" : provClinicCur.DEANum);
                            }
                            else
                            {
                    ...
                    case "prov.dEANum4":
                        if (dictRxs.ContainsKey(4))
                        {
                            ...
                            {
                                ProviderClinic provClinicCur = ProviderClinic.GetByProviderAndClinic(dictRxs[4].ProvNum, dictRxs[4].ClinicNum);
                                field.FieldValue = (provClinicCur == null ? "" : provClinicCur.DEANum);
                            }
                            else
                            {
                    ...
                    case "prov.dEANum5":
                        if (dictRxs.ContainsKey(5))
                        {
                            ...
                            {
                                ProviderClinic provClinicCur = ProviderClinic.GetByProviderAndClinic(dictRxs[5].ProvNum, dictRxs[5].ClinicNum);
                                field.FieldValue = (provClinicCur == null ? "" : provClinicCur.DEANum);
                            }
                            else
                            {
                    ...
                    case "prov.dEANum6":
                        if (dictRxs.ContainsKey(6))
                        {
                            ...
                            {
                                ProviderClinic provClinicCur = ProviderClinic.GetByProviderAndClinic(dictRxs[6].ProvNum, dictRxs[6].ClinicNum);
                                field.FieldValue = (provClinicCur == null ? "" : provClinicCur.DEANum);
                            }
                            else
                            {
