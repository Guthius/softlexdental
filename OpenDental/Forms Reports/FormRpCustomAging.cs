...
namespace OpenDental {
	public partial class FormRpCustomAging:ODForm {
		...
		private void FillGrid(List<AgingPat> listAgingPats) {
			...
			ODGridColumn col = new ODGridColumn("Patient",200);
			gridMain.Columns.Add(col);
			gridTotals.Columns.Add(col);
			col = new ODGridColumn("0-30 Days",100,sortingStrategy: ODGridSortingStrategy.AmountParse);
			gridMain.Columns.Add(col);
			gridTotals.Columns.Add(col);
			col = new ODGridColumn("31-60 Days",100, sortingStrategy: ODGridSortingStrategy.AmountParse);
			gridMain.Columns.Add(col);
			gridTotals.Columns.Add(col);
			col = new ODGridColumn("61-90 Days",100, sortingStrategy: ODGridSortingStrategy.AmountParse);
			gridMain.Columns.Add(col);
			gridTotals.Columns.Add(col);
			col = new ODGridColumn("> 90 Days",100, sortingStrategy: ODGridSortingStrategy.AmountParse);
			gridMain.Columns.Add(col);
			gridTotals.Columns.Add(col);
			col = new ODGridColumn("Total",100, sortingStrategy: ODGridSortingStrategy.AmountParse);
			gridMain.Columns.Add(col);
			gridTotals.Columns.Add(col);
