...
namespace OpenDental {
	...
	public class FormRpProcOverpaid: ODForm {
		...
		private ComboBoxClinicMulti comboBoxMultiClinics;
		...
		private void InitializeComponent()
		{
			...
			// labelClinic
			// 
			this.labelClinic.Location = new System.Drawing.Point(412, 36);
			...
			this.comboBoxMultiClinics.Location = new System.Drawing.Point(469, 34);
		...
		private void RefreshReport() {
			...
			if(_listSelectedProvNums.Count>0) {
				subTitleProviders=Lan.g(this,"For Providers:")+" "+string.Join(",",_listSelectedProvNums.Select(x => Provider.GetById(x).GetFormalName()));
			}
			string subtitleClinics=Lan.g(this,"All Clinics");
			if(comboBoxMultiClinics.ListSelectedClinics.Count>0 && !comboBoxMultiClinics.ListSelectedIndices.Contains(0)) {//All is not selected
				subtitleClinics=Lan.g(this,"For Clinics:")+" "+string.Join(",",comboBoxMultiClinics.ListSelectedClinics.Select(clinic => clinic.Abbr));
			}
