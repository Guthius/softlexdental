...
///<summary></summary>
	public class FormRpClaimNotSent : ODForm {
		...
		private ComboBoxClinicMulti comboClinicMulti;
		...
		private void InitializeComponent()
		{
			...
			this.comboClinicMulti = new OpenDental.UI.ComboBoxClinicMulti();
			...
			// labelClinics
			// 
			this.labelClinics.Location = new System.Drawing.Point(417, 18);
			...
			// comboClinicMulti
			// 
			this.comboClinicMulti.BackColor = System.Drawing.SystemColors.Window;
			this.comboClinicMulti.Location = new System.Drawing.Point(502, 15);
			this.comboClinicMulti.Name = "comboClinicMulti";
			this.comboClinicMulti.Size = new System.Drawing.Size(120, 21);
		...
		private void butRunReport_Click(object sender,EventArgs e) {
			...
			if(comboClinicMulti.IsAllSelected) {
				...
				subtitleClinics=string.Join(", ",comboClinicMulti.ListSelectedClinics.Select(x => x.Abbr));
			}
