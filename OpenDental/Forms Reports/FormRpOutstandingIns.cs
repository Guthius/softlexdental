...
namespace OpenDental {
	public partial class FormRpOutstandingIns:ODForm {
		...
		private void FillUsers() {
			...
			comboUserAssigned.Items.Add(new ODBoxItem<User>(Lans.g(this,"Unassigned"),new User()));
				...
				foreach(DisplayField fieldCur in listDisplayFields) {
					switch(fieldCur.InternalName) {
						...
						case "Type":
							...
							break;
						case "User":
							row.Cells.Add(User.GetName(claimCur.UserNum));
							break;
						case "PatName":
		...
		private void butRefresh_Click(object sender,EventArgs e) {
            Plugin.Trigger(this, "FormRpOutstandingIns_Button_Refresh");
			FillGrid();
		}
