...
namespace OpenDental
{
    ...
    public class FormRpInsAging : ODForm
    {
        ...
        private CheckBox checkShowBreakdownOptions;
        private GroupBox groupBreakdownOptions;
        private TextBox textGroupName;
        private TextBox textCarrier;
        private CheckBox checkGroupByGroupName;
        private CheckBox checkGroupByCarrier;
        ...
        private void InitializeComponent()
        {
            ...
            this.checkShowBreakdownOptions = new System.Windows.Forms.CheckBox();
            ...
            this.checkGroupByGroupName = new System.Windows.Forms.CheckBox();
            this.checkGroupByCarrier = new System.Windows.Forms.CheckBox();
            ...
            this.butCancel.Location = new System.Drawing.Point(653, 438);
            ...
            this.butOK.Location = new System.Drawing.Point(572, 438);
            ...
            this.labelFutureTrans.Location = new System.Drawing.Point(299, 442);
            ...
            // 
            // checkShowBreakdownOptions
            // 
            this.checkShowBreakdownOptions.Location = new System.Drawing.Point(18, 229);
            this.checkShowBreakdownOptions.Name = "checkShowBreakdownOptions";
            this.checkShowBreakdownOptions.Size = new System.Drawing.Size(197, 17);
            this.checkShowBreakdownOptions.TabIndex = 12;
            this.checkShowBreakdownOptions.Text = "Detailed Insurance Breakdown";
            this.checkShowBreakdownOptions.UseVisualStyleBackColor = true;
            this.checkShowBreakdownOptions.CheckedChanged += new System.EventHandler(this.checkShowBreakdownOptions_CheckedChanged);
            // 
            // groupBreakdownOptions
            // 
            this.groupBreakdownOptions.Controls.Add(this.groupBox2);
            this.groupBreakdownOptions.Controls.Add(this.groupBox1);
            this.groupBreakdownOptions.Location = new System.Drawing.Point(12, 251);
            this.groupBreakdownOptions.Name = "groupBreakdownOptions";
            this.groupBreakdownOptions.Size = new System.Drawing.Size(209, 165);
            ...
            this.labelGroupName.Size = new System.Drawing.Size(85, 13);
            ...
            this.labelCarrier.Size = new System.Drawing.Size(87, 13);
            ...
            // textGroupName
            // 
            this.textGroupName.Location = new System.Drawing.Point(97, 37);
            ...
            // textCarrier
            // 
            this.textCarrier.Location = new System.Drawing.Point(97, 13);
            this.textCarrier.Name = "textCarrier";
            this.textCarrier.Size = new System.Drawing.Size(100, 20);
            this.textCarrier.TabIndex = 2;
            // 
            // checkGroupByGroupName
            // 
            this.checkGroupByGroupName.Location = new System.Drawing.Point(9, 40);
            this.checkGroupByGroupName.Name = "checkGroupByGroupName";
            this.checkGroupByGroupName.Size = new System.Drawing.Size(105, 17);
            this.checkGroupByGroupName.TabIndex = 1;
            this.checkGroupByGroupName.Text = "Group Name";
            this.checkGroupByGroupName.UseVisualStyleBackColor = true;
            // 
            // checkGroupByCarrier
            // 
            this.checkGroupByCarrier.Location = new System.Drawing.Point(9, 21);
            this.checkGroupByCarrier.Name = "checkGroupByCarrier";
            this.checkGroupByCarrier.Size = new System.Drawing.Size(105, 17);
            this.checkGroupByCarrier.TabIndex = 0;
            this.checkGroupByCarrier.Text = "Carrier Name";
            this.checkGroupByCarrier.UseVisualStyleBackColor = true;
            // 
            // groupBox1
            // 
            this.groupBox1.Controls.Add(this.checkGroupByGroupName);
            this.groupBox1.Controls.Add(this.checkGroupByCarrier);
            ...
            this.Controls.Add(this.checkShowBreakdownOptions);
            ...
            this.MinimumSize = new System.Drawing.Size(756, 470);
        ...
        private void FormRpInsAging_Load(object sender, System.EventArgs e)
        {
            ...
            if (!listClinics.Exists(x => x.Id == Clinics.ClinicId))
            {//Could have a hidden clinic selected
            ...
            if (!checkShowBreakdownOptions.Checked)
            {
        ...
        private RpAgingParamObject GetParamsFromForm()
        {
            ...
            if (checkShowBreakdownOptions.Checked
                && (checkGroupByCarrier.Checked
                || checkGroupByGroupName.Checked
                || !string.IsNullOrWhiteSpace(textCarrier.Text)
                || !string.IsNullOrWhiteSpace(textGroupName.Text)))
            {
                rpo.IsDetailedBreakdown = true;
            }
            rpo.GroupByCarrier = checkGroupByCarrier.Checked;
            rpo.GroupByGroupName = checkGroupByGroupName.Checked;
        ...
        {
            groupBreakdownOptions.Visible = checkShowBreakdownOptions.Checked;
            if (!checkShowBreakdownOptions.Checked)
            {
                checkGroupByCarrier.Checked = false;
                checkGroupByGroupName.Checked = false;
            }
        }
    }
}
