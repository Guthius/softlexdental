...
///<summary></summary>
	public class FormModuleSetup:ODForm {
		...
		private void InitializeComponent(){
			...
			// 
			this.textApptAutoRefreshRange.DoAutoSave = false;
			...
			// 
			this.textApptWithoutProcsDefaultLength.DoAutoSave = false;
			...
			this.checkInsPlanExclusionsMarkDoNotBill.Text = "Ins plans with exclusions mark as Do Not Bill Ins (only if using UCR fee override" +
    ")";
			...
			this.groupRepeatingCharges.Location = new System.Drawing.Point(6, 440);
			...
			this.groupRecurringCharges.Size = new System.Drawing.Size(445, 121);
    ...
    "d, see manual)";
			...
			// 
			this.textClaimsReceivedDays.DoAutoSave = false;
			...
			// 
			this.textBillingElectBatchMax.DoAutoSave = false;
    ...
    "pt\"";
			...
			// 
			this.textStatementsCalcDueDate.DoAutoSave = false;
			...
			// 
			this.textPayPlansBillInAdvanceDays.DoAutoSave = false;
