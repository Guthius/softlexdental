namespace OpenDental{
	partial class FormEServicesSetup {
		...
		private void InitializeComponent() {
			...
			this.comboPPClinicUrl = new OpenDental.UI.ComboBoxClinic();
			...
			this.butPickClinicPP = new OpenDental.UI.Button();
			this.labelClinicPPurl = new System.Windows.Forms.Label();
    ...
    "ions when status is critical.";
			...
			this.gridListenerServiceStatusHistory.EditableEnterMovesDown = false;
    ...
    "ssword, leave the box empty.";
			...
			this.groupBox4.Controls.Add(this.butPickClinicPP);
			this.groupBox4.Controls.Add(this.labelClinicPPurl);
			...
			this.comboPPClinicUrl.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboPPClinicUrl.FormattingEnabled = true;
			this.comboPPClinicUrl.HqDescription = "None";
			this.comboPPClinicUrl.Location = new System.Drawing.Point(122, 168);
			this.comboPPClinicUrl.Name = "comboPPClinicUrl";
			this.comboPPClinicUrl.Size = new System.Drawing.Size(164, 21);
			...
			// butPickClinicPP
			// 
			this.butPickClinicPP.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butPickClinicPP.Autosize = false;
			this.butPickClinicPP.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butPickClinicPP.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butPickClinicPP.CornerRadius = 2F;
			this.butPickClinicPP.Location = new System.Drawing.Point(292, 169);
			this.butPickClinicPP.Name = "butPickClinicPP";
			this.butPickClinicPP.Size = new System.Drawing.Size(23, 20);
			this.butPickClinicPP.TabIndex = 272;
			this.butPickClinicPP.Text = "...";
			this.butPickClinicPP.Click += new System.EventHandler(this.butPickClinic_Click);
			// 
			// labelClinicPPurl
			// 
			this.labelClinicPPurl.Location = new System.Drawing.Point(41, 169);
			this.labelClinicPPurl.Name = "labelClinicPPurl";
			this.labelClinicPPurl.Size = new System.Drawing.Size(78, 17);
			this.labelClinicPPurl.TabIndex = 273;
			this.labelClinicPPurl.Text = "Clinic";
			this.labelClinicPPurl.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// butCopyToClipboard
			// 
			...
			this.gridPatPortalInviteRules.EditableEnterMovesDown = false;
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.textBoxNotificationBody.Location = new System.Drawing.Point(93, 132);
			this.textBoxNotificationBody.Multiline = true;
			this.textBoxNotificationBody.Name = "textBoxNotificationBody";
			this.textBoxNotificationBody.Size = new System.Drawing.Size(426, 126);
    ...
    "appointments via the web within seconds.";
			...
			this.checkRecallAllowProvSelection.Location = new System.Drawing.Point(337, 517);
    ...
    "d.";
			...
			this.gridWebSchedTimeSlots.EditableEnterMovesDown = false;
			...
			this.gridWebSchedOperatories.EditableEnterMovesDown = false;
			...
			this.gridWebSchedRecallTypes.EditableEnterMovesDown = false;
    ...
    "tment. Use Signup to enable.";
			...
			this.gridWebSchedNewPatApptOps.EditableEnterMovesDown = false;
			...
			this.gridWebSchedNewPatApptTimeSlots.EditableEnterMovesDown = false;
			...
			this.gridWSNPAReasons.EditableEnterMovesDown = false;
			...
			this.gridSmsSummary.EditableEnterMovesDown = false;
    ...
    " is received.";
			...
			this.gridConfStatuses.EditableEnterMovesDown = false;
			...
			this.gridRemindersMain.EditableEnterMovesDown = false;
    ...
    "";
		...
		private UI.Button butPickClinicPP;
		private System.Windows.Forms.Label labelClinicPPurl;
		private UI.ComboBoxClinic comboPPClinicUrl;
