...
namespace OpenDental{
    ...
    "type.  Referral slips are set in the referral edit window of each referral.";
			...
			this.grid1.Size = new System.Drawing.Size(370, 585);
			this.grid1.TabIndex = 2;
			this.grid1.Title = "Internal";
			this.grid1.CellDoubleClick += new System.EventHandler<UI.ODGridClickEventArgs>(this.grid1_CellDoubleClick);
			...
			this.grid2.Size = new System.Drawing.Size(414, 585);
			this.grid2.TabIndex = 3;
			this.grid2.Title = "Custom";
			this.grid2.CellDoubleClick += new System.EventHandler<UI.ODGridClickEventArgs>(this.grid2_CellDoubleClick);
			...
			this.butCopy2.Location = new System.Drawing.Point(738, 637);
			...
			this.butNew.Location = new System.Drawing.Point(653, 637);
			...
			this.butTools.Location = new System.Drawing.Point(400, 637);
		...
		private void FormSheetDefs_Load(object sender, System.EventArgs e) {
			...
			for(int i=0;i<LabelList.Count;i++){
				...
				if(Preference.GetLong(PreferenceName.LabelPatientDefaultSheetDefNum)==LabelList[i].SheetDefNum){
		...
		private void FillGrid2(){
			...
			col=new ODGridColumn(Lan.g("TableSheetDef","Type"),100);
			grid2.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableSheetDef","Use Mobile Layout"),100,HorizontalAlignment.Center);
			grid2.Columns.Add(col);
			grid2.Rows.Clear();
			ODGridRow row;
			for(int i=0;i<_listSheetDefs.Count;i++){
		...
		private void comboLabel_SelectionChangeCommitted(object sender,EventArgs e) {
			if(comboLabel.SelectedIndex==0){
				Preference.Update(PreferenceName.LabelPatientDefaultSheetDefNum,0);
			}
			else{
				Preference.Update(PreferenceName.LabelPatientDefaultSheetDefNum,LabelList[comboLabel.SelectedIndex-1].SheetDefNum);
			}
