namespace OpenDental{
	partial class FormSheetFieldSigBox {
		...
		private void InitializeComponent() {
			...
			this.textHeight.PrefNameBinding = OpenDentBusiness.PrefName.AccountingCashIncomeAccount;
			...
			this.textWidth.PrefNameBinding = OpenDentBusiness.PrefName.AccountingCashIncomeAccount;
			...
			this.textYPos.PrefNameBinding = OpenDentBusiness.PrefName.AccountingCashIncomeAccount;
			...
			this.textXPos.PrefNameBinding = OpenDentBusiness.PrefName.AccountingCashIncomeAccount;
