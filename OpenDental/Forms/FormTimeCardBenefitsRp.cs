...
namespace OpenDental
{
    ...
    public class FormTimeCardBenefitRp : ODForm
    {
        ...
        private void FillGridMain()
        {
            ...
            gridMain.Rows.Clear();
            List<Employee> listEmpsAll = Employee.All().OrderBy(x => x.LastName).ThenBy(x => x.FirstName).ToList();
        ...
        private void butExportGrid_Click(object sender, EventArgs e)
        {
            ...
            string filename = Storage.Default.CombinePath(fbd.SelectedPath, "BenefitsRpt_" + _dtNow.ToString("yyyyMMdd") + "_" + DateTime.Now.ToString("hhmm") + ".csv");
            Storage.Default.WriteAllText(filename, sb.ToString());
