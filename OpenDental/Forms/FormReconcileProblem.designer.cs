namespace OpenDental{
	partial class FormReconcileProblem {
		...
		private void InitializeComponent() {
			...
			this.gridProbExisting.HScrollVisible = false;
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.gridProbImport.HScrollVisible = false;
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.gridProbReconcile.HScrollVisible = false;
		...
		private UI.ODGrid gridProbReconcile;
		private UI.ODGrid gridProbImport;
		private UI.ODGrid gridProbExisting;
