...
namespace OpenDental {
	public partial class FormCommItemUserPrefs:ODForm {
		...
		private void FormCommItemUserPrefs_Load(object sender,EventArgs e) {
			...
			_userOdPrefClearNote=UserOdPrefs.GetByUserAndFkeyType(_userNumCur,UserPreferenceName.CommlogPersistClearNote).FirstOrDefault();
			_userOdPrefEndDate=UserOdPrefs.GetByUserAndFkeyType(_userNumCur,UserPreferenceName.CommlogPersistClearEndDate).FirstOrDefault();
			_userOdPrefUpdateDateTimeNewPat=UserOdPrefs.GetByUserAndFkeyType(_userNumCur,UserPreferenceName.CommlogPersistUpdateDateTimeWithNewPatient).FirstOrDefault();
