namespace OpenDental{
    ...
    "id Calc";
			...
			this.gridProcedureAdjustments.SelectionMode = OpenDental.UI.GridSelectionMode.Multiple;
			...
			this.gridRemarks.SelectionMode = OpenDental.UI.GridSelectionMode.Multiple;
