...
namespace OpenDental {
    ...
    "epare the screen for you.";
		...
		private void panelClose_Click(object sender,EventArgs e) {
			...
			if(Preference.GetString(PreferenceName.TerminalClosePassword)!="") {
				...
				iBox.ShowDialog();
				while(iBox.DialogResult==DialogResult.OK && iBox.textResult.Text!=Preference.GetString(PreferenceName.TerminalClosePassword)) {
