...
namespace OpenDental {
	...
	public class FormASAP:ODForm {
		...
		private void InitializeComponent() {
            ...
            this.comboClinic.Location = new System.Drawing.Point(356, 0);
            ...
            // labelClinic
            // 
            this.labelClinic.Location = new System.Drawing.Point(278, 4);
            ...
            this.gridAppts.EditableEnterMovesDown = false;
            ...
            this.gridAppts.TitleVisible = true;
            this.gridAppts.CellDoubleClick += new System.EventHandler<OpenDental.UI.ODGridClickEventArgs>(this.gridAppts_CellDoubleClick);
            ...
            this.gridRecalls.EditableEnterMovesDown = false;
            ...
            this.gridRecalls.TitleVisible = true;
            this.gridRecalls.CellDoubleClick += new System.EventHandler<OpenDental.UI.ODGridClickEventArgs>(this.gridRecalls_CellDoubleClick);
            // 
            // textDateStart
            // 
            ...
            this.gridWebSched.EditableEnterMovesDown = false;
            ...
            this.gridWebSched.TitleVisible = true;
            // 
            // mainMenu
            // 
		...
		private string GetTextMessageText(Clinic curClinic) {
			...
			if(_dateTimeChosen.Year > 1880) {//The user clicked on the appt schedule to get here.
				textTemplate=textTemplate.Replace("[Date]",_dateTimeChosen.ToString(Preferences.PatientCommunicationDateFormat));
			...
			if(listInputBoxParams.Count > 0 && inputBox.ShowDialog()==DialogResult.OK) {
				if(inputBox.DateEntered.Year > 1880) {
					textTemplate=textTemplate.Replace("[Date]",inputBox.DateEntered.ToString(Preferences.PatientCommunicationDateFormat));
				}
