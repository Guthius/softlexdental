...
namespace OpenDental {
	public partial class FormSheetFieldSpecial:ODForm {
		...
		private void SheetFilterChanged() {
			if(SheetDefCur.SheetType.GetAttributeOrDefault<SheetLayoutAttribute>().IsDynamic && SheetFieldDefCur.FieldName=="toothChart") {
		...
		private void FillFields() {
			...
			bool isDynamicSheetType=SheetDefCur.SheetType.GetAttributeOrDefault<SheetLayoutAttribute>().IsDynamic;
			...
			switch(listBoxAvailable.SelectedItem.ToString()) {
				case "toothChart":
					...
					if(SheetDefCur.SheetType.GetAttributeOrDefault<SheetLayoutAttribute>().IsDynamic) {
