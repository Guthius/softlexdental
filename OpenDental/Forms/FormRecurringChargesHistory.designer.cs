namespace OpenDental{
	partial class FormRecurringChargesHistory {
		...
		private void InitializeComponent() {
			...
			this.comboClinics = new OpenDental.UI.ComboBoxClinicMulti();
			...
			this.groupView.Controls.Add(this.butPickClinic);
			this.groupView.Controls.Add(this.comboStatuses);
			this.groupView.Controls.Add(this.labelClinics);
			...
			// labelClinics
			// 
			this.labelClinics.Location = new System.Drawing.Point(192, 45);
			this.labelClinics.Name = "labelClinics";
			this.labelClinics.Size = new System.Drawing.Size(51, 16);
			this.labelClinics.TabIndex = 35;
			this.labelClinics.Text = "Clinic";
			...
			this.comboClinics.Location = new System.Drawing.Point(245, 43);
			this.comboClinics.Name = "comboClinics";
			this.comboClinics.Size = new System.Drawing.Size(160, 21);
			this.comboClinics.TabIndex = 34;
			this.comboClinics.SelectionChangeCommitted += new OpenDental.UI.ComboBoxMulti.SelectionChangeCommittedHandler(this.FilterChanged);
			// 
		...
		private UI.ComboBoxClinicMulti comboClinics;
