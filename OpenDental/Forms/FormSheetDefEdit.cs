...
namespace OpenDental
{
    public partial class FormSheetDefEdit:ODForm {
		...
		private void butAddCheckBox_Click(object sender,EventArgs e) {
			...
			FormSheetFieldCheckBox FormS=new FormSheetFieldCheckBox(_sheetDefCur,SheetFieldDef.NewCheckBox("",0,0,11,11),this.IsInternal);
			FormS.ShowDialog();
			if(FormS.DialogResult!=DialogResult.OK  || FormS.SheetFieldDefCur==null) {//SheetFieldDefCur==null if it was Deleted
				return;
			}
		...
		private void LaunchEditWindow(SheetFieldDef field) {
			...
			switch(field.FieldType) {
				...
				case SheetFieldType.OutputText:
					...
					FormSO.SheetDefCur=_sheetDefCur;
				...
				case SheetFieldType.StaticText:
					...
					FormSS.SheetDefCur=_sheetDefCur;
				...
				case SheetFieldType.Image:
					...
					FormSI.SheetDefCur=_sheetDefCur;
				...
				case SheetFieldType.PatImage:
					...
					FormSPI.SheetDefCur=_sheetDefCur;
				...
				case SheetFieldType.Line:
					...
					FormSL.SheetDefCur=_sheetDefCur;
				...
				case SheetFieldType.Rectangle:
					...
					FormSR.SheetDefCur=_sheetDefCur;
					...
					break;
				case SheetFieldType.CheckBox:
					FormSheetFieldCheckBox FormSB=new FormSheetFieldCheckBox(_sheetDefCur,field,this.IsInternal);
					FormSB.ShowDialog();
				...
				case SheetFieldType.ComboBox:
					...
					FormSCB.SheetDefCur=_sheetDefCur;
				...
				case SheetFieldType.SigBoxPractice:
					...
					FormSBx.SheetDefCur=_sheetDefCur;
				...
				case SheetFieldType.Grid:
					...
					FormSFG.SheetDefCur=_sheetDefCur;
				...
				case SheetFieldType.ScreenChart:
					...
					FormSFC.SheetDefCur=_sheetDefCur;
