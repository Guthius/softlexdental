...
///<summary></summary>
	public partial class FormProcEdit : ODForm {
		...
		private void FillIns(bool refreshClaimProcsFirst){
			...
			col=new ODGridColumn(Lan.g("TableProcIns","Pri/Sec"),50,textAlignment: HorizontalAlignment.Center);
			gridIns.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcIns","Status"),50, textAlignment: HorizontalAlignment.Center);
			gridIns.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcIns","NoBill"),45, textAlignment: HorizontalAlignment.Center);
			gridIns.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcIns","Copay"),55, textAlignment: HorizontalAlignment.Right);
			gridIns.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcIns","Deduct"),55, textAlignment: HorizontalAlignment.Right);
			gridIns.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcIns","Percent"),55, textAlignment: HorizontalAlignment.Center);
			gridIns.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcIns","Ins Est"),55, textAlignment: HorizontalAlignment.Right);
			gridIns.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcIns","Ins Pay"),55, textAlignment: HorizontalAlignment.Right);
			gridIns.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcIns","WriteOff"),55, textAlignment: HorizontalAlignment.Right);
			gridIns.Columns.Add(col);
		...
		private void FillPayments(bool doRefreshData=true){
			...
			ODGridColumn col=new ODGridColumn(Lan.g("TableProcPay","Entry Date"),70,textAlignment: HorizontalAlignment.Center);
			gridPay.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcPay","Amount"),55, textAlignment: HorizontalAlignment.Right);
			gridPay.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcPay","Tot Amt"),55, textAlignment: HorizontalAlignment.Right);
			gridPay.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcPay","Note"),250, textAlignment: HorizontalAlignment.Left);
			gridPay.Columns.Add(col);
			gridPay.Rows.Clear();
			ODGridRow row;
		...
		private void FillAdj(){
			...
			ODGridColumn col=new ODGridColumn(Lan.g("TableProcAdj","Entry Date"),70, textAlignment: HorizontalAlignment.Center);
			gridAdj.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcAdj","Amount"),55, textAlignment: HorizontalAlignment.Right);
			gridAdj.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcAdj","Type"),100);
			gridAdj.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableProcAdj","Note"),250);
			gridAdj.Columns.Add(col);
			gridAdj.Rows.Clear();
			ODGridRow row;
