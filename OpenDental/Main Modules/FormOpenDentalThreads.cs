...
namespace OpenDental
{
    ...
    public partial class FormOpenDental : ODForm
    {
        ...
        ///or a user is logged off, for example. Only starts signal timer if interval preference is set to non-zero value.
        ...
        private void ReplicationMonitorWorker(ODThread o)
        {
            ...
            {//List will be automatically refreshed if null.
        ...
        #endregion
        #region ShowSplashThread
        ///<summary>Non-blocking call. Launches a splash screen with a progress bar that will listen specifically for SplashScreenProgress event types.
        ///Returns a close action that should be invoked whenever the progress window should close.</summary>
        private Action ShowSplash(bool hasProgress = false)
        {
            return ODProgress.ShowProgressBase(() => new FormSplash(hasProgress), "Thread_ODProgress_ShowProgressSplash");
        }
        #endregion
