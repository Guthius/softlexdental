...
{
    public partial class ContrImages : Module
    {
        ...
        private List<UserPreference> listUserOdPrefImageCats = null;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContrImages"/> class.
        /// </summary>
        public ContrImages()
        {
            ZoomImage = 1;
        ...
        public void InitializeOnStartup()
        {
            ...
            if (ClaimPaymentNum == 0 && EhrAmendmentCur == null)
            {//not an eob and not an amendment
        ...
        public void LayoutToolBar()
        {
            ...
            ToolBarMain.Buttons.Add(new ODToolBarButton("", Resources.IconPrint, "Print", "Print"));
            ToolBarMain.Buttons.Add(new ODToolBarButton("", Resources.IconDelete, "Delete", "Delete"));
            if (ClaimPaymentNum == 0)
            {
                ToolBarMain.Buttons.Add(new ODToolBarButton("", Resources.IconDocumentInfo, "Item Info", "Info"));
                ToolBarMain.Buttons.Add(new ODToolBarButton("Sign", null, "Sign this document", "Sign"));
            }
            ToolBarMain.Buttons.Add(new ODToolBarButton(ODToolBarButtonStyle.Separator));
            button = new ODToolBarButton(Lan.g(this, "Scan:"), null, "", "");
            button.Style = ODToolBarButtonStyle.Label;
            ToolBarMain.Buttons.Add(button);
            ToolBarMain.Buttons.Add(new ODToolBarButton("", Resources.IconScanner, "Scan Document", "ScanDoc"));
            ToolBarMain.Buttons.Add(new ODToolBarButton("", Resources.IconScanner, "Scan Multi-Page Document", "ScanMultiDoc"));
            if (ClaimPaymentNum == 0)
            {
                ToolBarMain.Buttons.Add(new ODToolBarButton("", Resources.IconXray, "Scan Radiograph", "ScanXRay"));
                ToolBarMain.Buttons.Add(new ODToolBarButton("", Resources.IconPhoto, "Scan Photo", "ScanPhoto"));
            }
            ToolBarMain.Buttons.Add(new ODToolBarButton(ODToolBarButtonStyle.Separator));
            ToolBarMain.Buttons.Add(new ODToolBarButton("Import", Resources.IconFolderImport, "Import From File", "Import"));
            ToolBarMain.Buttons.Add(new ODToolBarButton("Export", Resources.IconFolderExport, "Export To File", "Export"));
            ToolBarMain.Buttons.Add(new ODToolBarButton("Copy", Resources.IconCopy, "Copy displayed image to clipboard", "Copy"));
            ToolBarMain.Buttons.Add(new ODToolBarButton("Paste", Resources.IconPaste, "Paste From Clipboard", "Paste"));
            if (ClaimPaymentNum == 0)
            {
            ...
            {//claimpayment
                ToolBarMain.Buttons.Add(new ODToolBarButton(ODToolBarButtonStyle.Separator));
                ToolBarMain.Buttons.Add(new ODToolBarButton("Close", null, "Close window", "Close"));
            }
            if (ClaimPaymentNum == 0)
            {
                button = new ODToolBarButton("", Resources.IconTransformCrop, "Crop Tool", "Crop");
                button.Style = ODToolBarButtonStyle.ToggleButton;
                button.Pushed = IsCropMode;
                ToolBarPaint.Buttons.Add(button);
                button = new ODToolBarButton("", Resources.IconHand, "Hand Tool", "Hand");
                button.Style = ODToolBarButtonStyle.ToggleButton;
                button.Pushed = !IsCropMode;
                ToolBarPaint.Buttons.Add(button);
                ToolBarPaint.Buttons.Add(new ODToolBarButton(ODToolBarButtonStyle.Separator));
            }
            ToolBarPaint.Buttons.Add(new ODToolBarButton("", Resources.IconZoomIn, "Zoom In", "ZoomIn"));
            ToolBarPaint.Buttons.Add(new ODToolBarButton("", Resources.IconZoomOut,"Zoom Out", "ZoomOut"));
            ToolBarPaint.Buttons.Add(new ODToolBarButton("100", Resources.IconZoomReset, "Zoom 100", "Zoom100"));
            if (ClaimPaymentNum == 0)
            {
                ToolBarPaint.Buttons.Add(new ODToolBarButton(ODToolBarButtonStyle.Separator));
                button = new ODToolBarButton("Rotate:", null, "", "");
                button.Style = ODToolBarButtonStyle.Label;
                ToolBarPaint.Buttons.Add(button);
                ToolBarPaint.Buttons.Add(new ODToolBarButton("", Resources.IconFlipHorizontal, "Flip", "Flip"));
                ToolBarPaint.Buttons.Add(new ODToolBarButton("", Resources.IconRotateLeft, "Rotate Left", "RotateL"));
                ToolBarPaint.Buttons.Add(new ODToolBarButton("", Resources.IconRotateRight, "Rotate Right", "RotateR"));
            }
        ...
        public void LayoutAmendmentToolBar()
        {
            ...
            ToolBarMain.Buttons.Add(new ODToolBarButton("", Resources.IconDelete, "Delete", "Delete"));
            ToolBarMain.Buttons.Add(new ODToolBarButton(ODToolBarButtonStyle.Separator));
            button = new ODToolBarButton("Scan:", null, "", "");
            button.Style = ODToolBarButtonStyle.Label;
            ToolBarMain.Buttons.Add(button);
            ToolBarMain.Buttons.Add(new ODToolBarButton("", Resources.IconScanner, "Scan Document", "ScanDoc"));
            ToolBarMain.Buttons.Add(new ODToolBarButton("", Resources.IconScanner, "Scan Multi-Page Document", "ScanMultiDoc")); // TODO: This needs a new icon...
            ToolBarMain.Buttons.Add(new ODToolBarButton(ODToolBarButtonStyle.Separator));
            ToolBarMain.Buttons.Add(new ODToolBarButton("Import", Resources.IconFolderImport, "Import From File", "Import"));
            ToolBarMain.Buttons.Add(new ODToolBarButton("Export", Resources.IconFolderExport, "Export To File", "Export"));
            ToolBarMain.Buttons.Add(new ODToolBarButton("Copy", Resources.IconCopy, "Copy displayed image to clipboard", "Copy"));
        ...
        public void ModuleSelected(long patNum, long docNum)
        {
            ...
            {
                FormFriendlyException.Show("Error accessing images.", ex);
            }

            RefreshModuleScreen();
            if (panelNote.Visible)
            {//Notes and sig box may have been visible previously, with info from another image/patient
        ...
        public void ModuleUnselected()
        {
            ...
            {
                if (c.GetType() == typeof(WebBrowser))
                {//_webBrowserDocument
                    Controls.Remove(c);
                    c.Dispose();
                }
        ...
        private void RefreshModuleScreen()
        {
            ...
            if (XVWebBridge.IsDisplayingImagesInProgram && PatCur != null)
            {
                ...
                _threadImageRequest.AddExceptionHandler(new ODThread.ExceptionDelegate((ex) =>
                {
                    if (InvokeRequired)
                    {
                        Invoke((Action)(() => FormFriendlyException.Show("Unable to display Apteryx Images", ex)));
                    }
                    else
                    {
                        FormFriendlyException.Show("Unable to display Apteryx Images", ex);
                    }
                }));
        ...
        public void SelectTreeNode(TreeNode node, string localPath = "")
        {
            ...
            EraseCurrentImages();
            if (isNodeOldDoc)
            {//We are no longer using the previously saved image, try to delete it if it is in the temp directory.
            ...
            else if (nodeId.NodeType == ImageNodeType.Eob)
            {
                ...
                if (ImagesCur[0] == null)
                {
                    if (Path.GetExtension(eob.FileName).ToLower() == ".pdf")
                    {//Adobe acrobat file.
            ...
            else if (nodeId.NodeType == ImageNodeType.Doc)
            {
                ...
                if (ImagesCur[0] == null)
                {
                    ...
                    else if (Path.GetExtension(DocSelected.FileName).ToLower() == ".pdf")
                    {//Adobe acrobat file.
            ...
            else if (nodeId.NodeType == ImageNodeType.Amd)
            {
                ...
                if (ImagesCur[0] == null)
                {
                    if (Path.GetExtension(amd.FileName).ToLower() == ".pdf")
                    {//Adobe acrobat file.
        ...
        public void FillDocList(bool keepSelection)
        {
            ...
            {//Document tree folders persistent expand/collapse per user
                ...
                {//User has changed.  Expand image categories based on user preference.
                    _listExpandedCats.Clear();
                    //listUserOdPrefImageCats = UserPreference.GetByKey(Security.CurrentUser.Id, UserPreferenceName.Definition);//Update override list.
                    //foreach (Definition curDef in listImageCatDefs)
                    //{
                    //    //Should only be one value with associated Fkey.
                    //    UserPreference userOdPrefTemp = listUserOdPrefImageCats.FirstOrDefault(x => x.Fkey == curDef.Id);
                    //    if (userOdPrefTemp != null)
                    //    {//User has a preference for this image category.
                    //        if (!userOdPrefTemp.Value.Contains("E"))
                    //        {//The user's preference is to collapse this category.
                    //            continue;
                    //        }
                    //        for (int j = 0; j < treeDocuments.Nodes.Count; j++)
                    //        {//Enumerate the image categories.
        ...
        private void ToolBarScan_Click(string scanType)
        {
            ...
            {
                string message = "";
                if (errorCode == (int)EZTwainErrorCode.EZTEC_USER_CANCEL)
                {//19
                 //message="\r\nScanning cancelled.";//do nothing
                    return;
                }
                else if (errorCode == (int)EZTwainErrorCode.EZTEC_JPEG_DLL)
                {//22
                    message = "Missing dll\r\n\r\nRequired file EZJpeg.dll is missing.";
                }
                else if (errorCode == (int)EZTwainErrorCode.EZTEC_0_PAGES)
                {//38
                 //message="\r\nScanning cancelled.";//do nothing
                    return;
                }
                else if (errorCode == (int)EZTwainErrorCode.EZTEC_NO_PDF)
                {//43
                    message = "Missing dll\r\n\r\nRequired file EZPdf.dll is missing.";
                }
                else if (errorCode == (int)EZTwainErrorCode.EZTEC_DEVICE_PAPERJAM)
                {//76
        ...
        private void ToolBarScanMulti_Click()
        {
            ...
            if (errorCode != 0)
            {
                ...
                else if (errorCode == (int)EZTwainErrorCode.EZTEC_DS_FAILURE)
                {//5
        ...
        void ToolBarCopy_Click()
        {
            if (treeDocuments.SelectedNode == null || treeDocuments.SelectedNode.Tag == null)
            {
                MessageBox.Show(
                    "Please select a document before copying.", 
                    "Images", 
        ...
        private void ToolBarPaste_Click()
        {
            ...
            {
                MessageBox.Show(
                    "Could not paste contents from the clipboard. Please try again.", 
                    "Images", 
                    MessageBoxButtons.OK, 
            ...
            {
                MessageBox.Show(
                    "No bitmap present on clipboard.",
                    "Images", 
                    MessageBoxButtons.OK, 
                    MessageBoxIcon.Error);
        ...
        private void ToolBarCrop_Click()
        {
            ...
            if (ToolBarPaint.Buttons["Crop"].Pushed)
            { //Crop Mode
        ...
        private void TreeDocuments_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (NodeIdentifierDown.Equals((ImageNodeTag)nodeOver.Tag))
        ...
        private void TreeDocuments_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (TimeMouseMoved.Year == 1)
            {//No valid mouse movements occurred after the mouse down event and before the mouse up event.
        ...
        private void InvalidateSettings(ImageSettingFlags settings, bool reloadZoomTransCrop, bool[] mountIdxsToUpdate)
        {
            ...
            {//Create the thread if it has not been created, or if it was killed for some reason.
