...
{
    public partial class UserControlSetupWizPrinter : SetupWizardControl
    {
        public UserControlSetupWizPrinter() => InitializeComponent();
        ...
        protected override void OnValidating(CancelEventArgs e)
        {
            ...
            if (textScanDocQuality.errorProvider1.GetError(textScanDocQuality) != "" || textScanDocResolution.errorProvider1.GetError(textScanDocResolution) != "")
            {
            ...
            if (textScanDocQuality.Text == "100" || (radioScanDocUseOptionsBelow.Checked && PIn.Int(textScanDocResolution.Text) > 300))
            {
                if (!MsgBox.Show("FormSetupWizard", MsgBoxButtons.YesNo, "With the provided scanner compression settings, the file created may be extremely large.  Would you like to continue?"))
                {
                    e.Cancel = true;
                    return;
                }
