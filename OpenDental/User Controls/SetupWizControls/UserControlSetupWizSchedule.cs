...
{
    public partial class UserControlSetupWizSchedule : SetupWizardControl
    {
        ...
        protected override void OnValidating(CancelEventArgs e)
        {
            ...
            Error = "In order for this section to be considered complete, you must set up at least one schedule for every provider.";
