...
namespace OpenDental
{
    public abstract class EZTwain
    {
        ...
        [DllImport("Eztwain4.dll", CharSet = CharSet.Ansi, ExactSpelling = true, EntryPoint = "TWAIN_SetScanAnotherPagePrompt")]
        public static extern
        ...
        [DllImport("Eztwain4.dll", CharSet = CharSet.Ansi, ExactSpelling = true, EntryPoint = "TWAIN_UniversalLicense")]
        public static extern
        void UniversalLicense(string sLicensee, int nKey);

        [DllImport("Eztwain4.dll", CharSet = CharSet.Ansi, ExactSpelling = true, EntryPoint = "TWAIN_InHouseApplicationLicense")]
        public static extern
        ...
        [DllImport("Eztwain4.dll", CharSet = CharSet.Ansi, ExactSpelling = true, EntryPoint = "TWAIN_SetAutoCropSizeRange")]
        public static extern
        void SetAutoCropSizeRange(double minW, double maxW, double minH, double maxH, int nUnits);

        [DllImport("Eztwain4.dll", CharSet = CharSet.Ansi, ExactSpelling = true, EntryPoint = "TWAIN_ClearAutoCropSizeRange")]
        public static extern
        ...
        [DllImport("Eztwain4.dll", CharSet = CharSet.Ansi, ExactSpelling = true, EntryPoint = "TWAIN_CanDoDuplex")]
        public static extern
        bool CanDoDuplex();
        ...
        [DllImport("Eztwain4.dll", CharSet = CharSet.Ansi, ExactSpelling = true, EntryPoint = "TWAIN_GetImageReadyTimeout")]
        public static extern
        ...
        [DllImport("Eztwain4.dll", CharSet = CharSet.Ansi, ExactSpelling = true, EntryPoint = "TWAIN_SetQAMode")]
        public static extern
        void SetQAMode(int nMode);
        [DllImport("Eztwain4.dll", CharSet = CharSet.Ansi, ExactSpelling = true, EntryPoint = "TWAIN_GetQAMode")]
        public static extern
        int GetQAMode();
