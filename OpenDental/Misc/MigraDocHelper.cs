...
namespace OpenDental
{
    ...
    {
        /// <summary>
        /// Creates a container frame in a section. This allows other objects to be placed absolutely within a given area by adding more textframes within this one. 
        ...
        {
            string imageFileName = Preferences.GetRandomTempFile(".tmp");
        ...
        /// </summary>
        private static void DrawTextWithWordSplits(Paragraph par, MigraDoc.DocumentObjectModel.Font fontBody, int colWidth, string cellText, XGraphics gx, XFont xFont)
        {
            string line = "";
            string word = "";
        ...
        /// </summary>
        private static void DrawWordChunkByChunk(string word, int colWidth, Paragraph par, MigraDoc.DocumentObjectModel.Font fontBody, XGraphics gx, XFont xFont)
        {
            string chunk = "";
        ...
        /// </summary>
        private static bool DoesTextFit(string text, int colWidth, XGraphics gx, XFont xFont) => gx.MeasureString(text, xFont).Width < colWidth;
    }
}