...
namespace OpenDental
{
    ...
    public class FormTimeCard : ODForm
    {
        ...
        private List<TimeAdjustment> TimeAdjustList;
        ...
        private TimeAdjustment _timeAdjustNote;
        ...
        private void InitializeComponent()
        {
            ...
            // labelNote
            // 
            this.labelNote.Location = new System.Drawing.Point(291, 28);
            this.labelNote.Name = "labelNote";
            this.labelNote.Size = new System.Drawing.Size(39, 18);
            ...
            this.textNote.Size = new System.Drawing.Size(274, 20);
        ...
        private DateTime GetDateForRow(int i)
        {
            ...
            {
                return ((ClockEvent)mergedAL[i]).Date1Displayed.Date;
            }
            else if (mergedAL[i].GetType() == typeof(TimeAdjustment))
            {
                return ((TimeAdjustment)mergedAL[i]).Date.Date;
            }
        ...
        private void FillMain(bool fromDB)
        {
            ...
            if (mergedAL.Count > 0)
            {  //Have to check fromDB here because we dont want to call DB every timer tick
                if (fromDB)
                {
            ...
            for (int i = 0; i < mergedAL.Count; i++)
            {
                ...
                if (type == typeof(ClockEvent))
                {
                    ...
                    {
                        row.Cells.Add(clock.Date1Displayed.ToLongTimeString());
                    }
                    else
                    {
        ...
        private void gridMain_CellDoubleClick(object sender, ODGridClickEventArgs e)
        {
            ...
            if (gridMain.Rows[e.Row].Tag.GetType() == typeof(TimeAdjustment))
            {
                ...
                TimeAdjustment adjust = (TimeAdjustment)gridMain.Rows[e.Row].Tag;
        ...
        private void butAdj_Click(object sender, EventArgs e)
        {
            ...
            adjust.ClinicId = Clinics.ClinicId;
            ...
            {
                adjust.Date = new DateTime(dateStop.Year, dateStop.Month, dateStop.Day,
        ...
        private void SaveNoteToDb()
        {
            ...
            if (_timeAdjustNote.Id == 0)
            {//adding a note for the first time.
                if (textNote.Text != "")
                {//Do not create a row if not needed.
