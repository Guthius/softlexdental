...
{
    public class PerioPalBridge : CommandLineBridge
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PerioPalBridge"/> class.
        /// </summary>
        public PerioPalBridge() : base("PerioPal", "", "")
        {
            RequirePatient = true;
        }
        ...
        protected override bool PrepareToRun(long programId, Patient patient, out string arguments)
        {
            ...
            arguments = "\"" +
                ...
                ((!string.IsNullOrEmpty(patient.MedUrgNote) || patient.Premed) ? "Y;" : "N;") + "\"";
