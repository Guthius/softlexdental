...
namespace OpenDental.Bridges
{
    ...
    public class TrophyEnhanced
    {
        ...
        public static void SendData(Program ProgramCur, Patient pat)
        {
            ...
            string storagePath = ProgramProperties.GetPropVal(ProgramCur.Id, "Storage Path");
            ...
            {//no trophy folder assigned yet
                bool isNumberedMode = ProgramProperties.GetPropVal(ProgramCur.Id, "Enter 1 to enable Numbered Mode") == "1";
                try
                {
                    if (isNumberedMode)
                    {
