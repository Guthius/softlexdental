...
{
    public class VixWinBase36Bridge : VixWinNumberedBridge
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VixWinBase41Bridge"/> class.
        /// </summary>
        public VixWinBase36Bridge() : base("VixWin (Base36)", "")
        {
        }
        ...
        /// <summary>
        /// Gets the base-36 identifier for the specified patient.
        /// </summary>
        /// <param name="programId">The ID of the program.</param>
        /// <param name="patient">The patient.</param>
        ...
        protected override string GetIdentifier(long programId, Patient patient)
        {
            ...
            for (int i = 5; i >= 0; i--)
            {
                ...
                result += base36Characters[(int)temp];
            }
