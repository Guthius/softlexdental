...
namespace OpenDental
{
    ...
    public class FormDeposits : ODForm
    {
        ...
        private void FillGrid()
        {
            ...
            if (!Security.CurrentUser.ClinicRestricted && comboClinic.SelectedIndices.Contains(0))
            {//All is an option in comboClinic and is selected.
             //Blank by design for Deposits.GetForClinics(...).
            }
            else
            {
                int listStep = (Security.CurrentUser.ClinicRestricted ? 0 : 1);//If the All option is available, then all indices are offset by 1.
                comboClinic.ListSelectedIndices.ForEach(x => listSelectedClinicNums.Add(_listClinics[x - listStep].Id));
            }
        ...
        {
            if (!Security.CurrentUser.ClinicRestricted //All is in comboClinic
        ...
        private void butAdd_Click(object sender, System.EventArgs e)
        {
            ...
            deposit.BankAccountInfo = Preference.GetString(PreferenceName.PracticeBankNumber);
