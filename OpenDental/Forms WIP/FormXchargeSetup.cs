...
namespace OpenDental
{
    ...
    "eb.";
        ...
        private void comboClinic_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            if (isXWebEnabled && !ValidateXWeb())
            {//error message box displayed in ValidateXWeb()
            ...
            _listProgProps.FindAll(x => x.ClinicId == _listUserClinicNums[_indexClinicRevert] && x.Key == "Username")
                .ForEach(x => x.Value = textUsername.Text.Trim());//always 1 item, null safe
            _listProgProps.FindAll(x => x.ClinicId == _listUserClinicNums[_indexClinicRevert] && x.Key == "Password")
                .ForEach(x => x.Value = passwordEncrypted);//always 1 item, null safe
            _listProgProps.FindAll(x => x.ClinicId == _listUserClinicNums[_indexClinicRevert] && x.Key == "PromptSignature")
                .ForEach(x => x.Value = POut.Bool(checkPromptSig.Checked));//always 1 item, null safe
            _listProgProps.FindAll(x => x.ClinicId == _listUserClinicNums[_indexClinicRevert] && x.Key == "PrintReceipt")
                .ForEach(x => x.Value = POut.Bool(checkPrintReceipt.Checked));//always 1 item, null safe
            _listProgProps.FindAll(x => x.ClinicId == _listUserClinicNums[_indexClinicRevert] && x.Key == "XWebID")
                .ForEach(x => x.Value = textXWebID.Text.Trim());//always 1 item, null safe
            _listProgProps.FindAll(x => x.ClinicId == _listUserClinicNums[_indexClinicRevert] && x.Key == "AuthKey")
                .ForEach(x => x.Value = textAuthKey.Text.Trim());//always 1 item, null safe
            _listProgProps.FindAll(x => x.ClinicId == _listUserClinicNums[_indexClinicRevert] && x.Key == "TerminalID")
                .ForEach(x => x.Value = textTerminalID.Text.Trim());//always 1 item, null safe
            _listProgProps.FindAll(x => x.ClinicId == _listUserClinicNums[_indexClinicRevert] && x.Key == "IsOnlinePaymentsEnabled")
        ...
        private void butOK_Click(object sender, EventArgs e)
        {
            ...
            _listProgProps.FindAll(x => x.ClinicId == clinicNum && x.Key == "Password")
                .ForEach(x => x.Value = passwordEncrypted);//always 1 item; null safe
            _listProgProps.FindAll(x => x.ClinicId == clinicNum && x.Key == "PromptSignature")
                .ForEach(x => x.Value = POut.Bool(checkPromptSig.Checked));//always 1 item, null safe
            _listProgProps.FindAll(x => x.ClinicId == clinicNum && x.Key == "PrintReceipt")
                .ForEach(x => x.Value = POut.Bool(checkPrintReceipt.Checked));//always 1 item, null safe
            _listProgProps.FindAll(x => x.ClinicId == clinicNum && x.Key == "XWebID")
                .ForEach(x => x.Value = textXWebID.Text.Trim());//always 1 item, null safe
            _listProgProps.FindAll(x => x.ClinicId == clinicNum && x.Key == "AuthKey")
            ...
            _listProgProps.FindAll(x => x.ClinicId == clinicNum && x.Key == "TerminalID")
                .ForEach(x => x.Value = textTerminalID.Text.Trim());//always 1 item, null safe
            _listProgProps.FindAll(x => x.ClinicId == clinicNum && x.Key == "IsOnlinePaymentsEnabled")
                .ForEach(x => x.Value = POut.Bool(checkWebPayEnabled.Checked));//always 1 item, null safe
            ...
            if (!ValidatePaymentTypes(true))
            {//if validation fails, message box will already have been shown
                return;
            }
            ...
            //_listProgProps.FindAll(x => x.Key == "IsOnlinePaymentsEnabled" && PIn.Bool(x.Value)).ForEach(x =>
            //{
            ...
            //    ProgramProperty ppPayConnectOnlinePayments = _listPayConnectWebPayProgProps.FirstOrDefault(y => y.ClinicId == x.ClinicId);
