...
namespace OpenDental
{
    public partial class FormRecurringChargesHistory : ODForm
    {
        ...
        private void FillGrid()
        {
            ...
            gridMain.Columns.Add(new ODGridColumn(Lan.g(this, "Family Bal"), 70, HorizontalAlignment.Right,
                ODGridSortingStrategy.AmountParse));
            gridMain.Columns.Add(new ODGridColumn(Lan.g(this, "PayPlan Due"), 80, HorizontalAlignment.Right,
                ODGridSortingStrategy.AmountParse));
            gridMain.Columns.Add(new ODGridColumn(Lan.g(this, "Total Due"), 65, HorizontalAlignment.Right,
                ODGridSortingStrategy.AmountParse));
            gridMain.Columns.Add(new ODGridColumn(Lan.g(this, "Repeat Amt"), 75, HorizontalAlignment.Right,
                ODGridSortingStrategy.AmountParse));
            gridMain.Columns.Add(new ODGridColumn(Lan.g(this, "Charge Amt"), 85, HorizontalAlignment.Right,
                ODGridSortingStrategy.AmountParse));
            ...
            foreach (RecurringCharge charge in _listRecurringCharges.OrderBy(x => x.DateTimeCharge))
            {
                ...
                if (!datePicker.IsInDateRange(charge.DateTimeCharge)
                    || (!charge.ClinicNum.In(comboClinics.ListSelectedClinicNums))
                ...
                row.Cells.Add(Clinic.GetById(charge.ClinicNum)?.Description ?? "");

                row.Cells.Add(charge.DateTimeCharge.ToString());
                row.Cells.Add(Lans.g(this, charge.ChargeStatus.GetDescription()));
                row.Cells.Add(User.GetById(charge.UserNum)?.UserName ?? "");
