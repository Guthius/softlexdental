    ...
    public partial class FormPerio : ODForm
    {
        ...
        private void CreateNewPerioChart()
        {
            ...
            if (PerioExams.ListExams.Count == 0 || Preference.GetBool(PreferenceName.PerioSkipMissingTeeth))
            {
                ...
                {
                    if (_listMissingTeeth[i].CompareTo("A") >= 0 && _listMissingTeeth[i].CompareTo("Z") <= 0)
        ...
        private void butCopyPrevious_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < listPerio.Count; i++)
            { //add all of the previous exam's measures to this perio exam.
        ...
        private void FormPerio_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            Plugin.Trigger(this, "FormPerio_Closing");
        }
    }
}