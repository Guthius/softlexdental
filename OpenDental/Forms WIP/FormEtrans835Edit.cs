...
namespace OpenDental {
	public partial class FormEtrans835Edit:ODForm {
		...
		private Claim ClaimSelectionHelper(Hx835_Claim claimPaid) {
			DataTable ptTable=Patients.GetPtDataTable(false,claimPaid.PatientName.Lname,claimPaid.PatientName.Fname
				,"","",false,"","","","","",0,false,false,DateTime.MinValue,0,"","","","","",""
			);//Mimics FormPatientSelect.cs
