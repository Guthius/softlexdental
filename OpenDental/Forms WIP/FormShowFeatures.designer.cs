...
namespace OpenDental {
	partial class FormShowFeatures {
		...
		private void InitializeComponent()
		{
			...
			this.checkCapitation = new OpenDental.PreferenceCheckBox();
			this.checkMedicaid = new OpenDental.PreferenceCheckBox();
			this.checkAdvancedIns = new System.Windows.Forms.CheckBox();
			this.checkClinical = new OpenDental.PreferenceCheckBox();
			this.checkBasicModules = new OpenDental.PreferenceCheckBox();
			this.checkPublicHealth = new OpenDental.PreferenceCheckBox();
			this.checkEnableClinics = new System.Windows.Forms.CheckBox();
			this.checkDentalSchools = new OpenDental.PreferenceCheckBox();
			this.checkRepeatCharges = new OpenDental.PreferenceCheckBox();
			this.checkInsurance = new OpenDental.PreferenceCheckBox();
			this.checkHospitals = new OpenDental.PreferenceCheckBox();
			this.checkMedicalIns = new OpenDental.PreferenceCheckBox();
			this.checkEhr = new OpenDental.PreferenceCheckBox();
			this.checkSuperFam = new OpenDental.PreferenceCheckBox();
			this.label1 = new System.Windows.Forms.Label();
			this.checkPatClone = new OpenDental.PreferenceCheckBox();
			this.checkQuestionnaire = new OpenDental.PreferenceCheckBox();
			this.checkTrojanCollect = new OpenDental.PreferenceCheckBox();
			this.checkShowEnterprise = new OpenDental.PreferenceCheckBox();
			this.checkShowReactivations = new OpenDental.PreferenceCheckBox();
			this.SuspendLayout();
			// 
			// butCancel
			// 
			...
			this.checkCapitation.Preference = OpenDentBusiness.PreferenceName.EasyHideCapitation;
			this.checkCapitation.Inverted = true;
			...
			this.checkMedicaid.Preference = OpenDentBusiness.PreferenceName.EasyHideMedicaid;
			this.checkMedicaid.Inverted = true;
			...
			this.checkClinical.Preference = OpenDentBusiness.PreferenceName.EasyHideClinical;
			this.checkClinical.Inverted = true;
			...
			this.checkBasicModules.Preference = OpenDentBusiness.PreferenceName.EasyBasicModules;
			this.checkBasicModules.Inverted = false;
			...
			this.checkPublicHealth.Preference = OpenDentBusiness.PreferenceName.EasyHidePublicHealth;
			this.checkPublicHealth.Inverted = true;
			...
			this.checkDentalSchools.Preference = OpenDentBusiness.PreferenceName.EasyHideDentalSchools;
			this.checkDentalSchools.Inverted = true;
			...
			this.checkRepeatCharges.Preference = OpenDentBusiness.PreferenceName.EasyHideRepeatCharges;
			this.checkRepeatCharges.Inverted = true;
			...
			this.checkInsurance.Preference = OpenDentBusiness.PreferenceName.EasyHideInsurance;
			this.checkInsurance.Inverted = true;
			...
			this.checkHospitals.Preference = OpenDentBusiness.PreferenceName.EasyHideHospitals;
			this.checkHospitals.Inverted = true;
			...
			this.checkMedicalIns.Preference = OpenDentBusiness.PreferenceName.ShowFeatureMedicalInsurance;
			this.checkMedicalIns.Inverted = false;
			...
			this.checkEhr.Preference = OpenDentBusiness.PreferenceName.ShowFeatureEhr;
			this.checkEhr.Inverted = false;
			...
			this.checkSuperFam.Preference = OpenDentBusiness.PreferenceName.ShowFeatureSuperfamilies;
			this.checkSuperFam.Inverted = false;
			...
			this.checkPatClone.Preference = OpenDentBusiness.PreferenceName.ShowFeaturePatientClone;
			this.checkPatClone.Inverted = false;
			...
			this.checkQuestionnaire.Preference = OpenDentBusiness.PreferenceName.AccountShowQuestionnaire;
			this.checkQuestionnaire.Inverted = false;
			...
			this.checkTrojanCollect.Preference = OpenDentBusiness.PreferenceName.AccountShowTrojanExpressCollect;
			this.checkTrojanCollect.Inverted = false;
			...
			this.checkShowEnterprise.Preference = OpenDentBusiness.PreferenceName.ShowFeatureEnterprise;
			this.checkShowEnterprise.Inverted = false;
			...
			this.checkShowReactivations.Preference = OpenDentBusiness.PreferenceName.ShowFeatureReactivations;
			this.checkShowReactivations.Inverted = false;
		...
		private OpenDental.PreferenceCheckBox checkClinical;
		private OpenDental.PreferenceCheckBox checkBasicModules;
		private OpenDental.PreferenceCheckBox checkPublicHealth;
		private System.Windows.Forms.CheckBox checkEnableClinics;
		private OpenDental.PreferenceCheckBox checkDentalSchools;
		private OpenDental.PreferenceCheckBox checkRepeatCharges;
		private PreferenceCheckBox checkInsurance;
		private PreferenceCheckBox checkHospitals;
		private PreferenceCheckBox checkMedicalIns;
		private PreferenceCheckBox checkEhr;
		private PreferenceCheckBox checkSuperFam;
		private System.Windows.Forms.Label label1;
		private PreferenceCheckBox checkPatClone;
		private PreferenceCheckBox checkQuestionnaire;
		private PreferenceCheckBox checkTrojanCollect;
		///<summary>Keeps track the clinic preference state when the window was loaded.</summary>
		private PreferenceCheckBox checkShowEnterprise;
		private PreferenceCheckBox checkMedicaid;
		private PreferenceCheckBox checkCapitation;
		private PreferenceCheckBox checkShowReactivations;
	}
}
