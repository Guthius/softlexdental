...
namespace OpenDental
{
    ...
    public class FormDisplayFieldCategories : ODForm
    {
        ...
        private void FormDisplayFields_Load(object sender, EventArgs e)
        {
            ...
            {
                if (cat == DisplayFieldCategory.None)
                {//skip None because user not allowed to select that
                    continue;
                }
                if (cat == DisplayFieldCategory.OrthoChart)
                { //orthochart tabs can have their own name.
        ...
        private void ShowCategoryEdit()
        {
            ...
            {//All other display fields use the base display fields window.
