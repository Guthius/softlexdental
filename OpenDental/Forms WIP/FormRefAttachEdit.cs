...
namespace OpenDental{
    ...
    public bool IsNew;
		...
		private void butDetach_Click(object sender,EventArgs e) {
			...
			SecurityLog.Write(Permissions.RefAttachDelete,RefAttachCur.PatNum,"Referral attachment deleted for "+Referrals.GetNameFL(RefAttachCur.ReferralNum));
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			if((ReferralType)listRefType.SelectedIndex==ReferralType.RefTo && Preference.GetBool(PreferenceName.ShowFeatureEhr)) {
				string warning="";
