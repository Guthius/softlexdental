...
namespace OpenDental {
	public partial class FormUnschedListPatient:ODForm {
		...
		private void FillGrid() {
			...
			ODGridColumn col=new ODGridColumn("Date",65,HorizontalAlignment.Center);
			gridMain.Columns.Add(col);
			col=new ODGridColumn("AptStatus",90);
			gridMain.Columns.Add(col);
			col=new ODGridColumn("UnschedStatus",110);
			gridMain.Columns.Add(col);
			col=new ODGridColumn("Prov",80);
			gridMain.Columns.Add(col);
			col=new ODGridColumn("Procedures",150);
			gridMain.Columns.Add(col);
			col=new ODGridColumn("Notes",200);
			gridMain.Columns.Add(col);
			gridMain.Rows.Clear();
			ODGridRow row;
