...
namespace OpenDental
{
    ...
    public class FormProviderIdentEdit : ODForm
    {
        ...
        public ProviderIdentity ProvIdentCur;
        ...
        private void FormProviderIdentEdit_Load(object sender, System.EventArgs e)
        {
            ...
            listType.Items.AddRange(Enum.GetNames(typeof(ProviderIdentityType)));
            //}
            listType.SelectedIndex = (int)ProvIdentCur.Type;
            textIDNumber.Text = ProvIdentCur.Number;
        }

        private void butOK_Click(object sender, System.EventArgs e)
        {
            ProvIdentCur.PayorId = textPayorID.Text;
            ProvIdentCur.Type = (ProviderIdentityType)listType.SelectedIndex;
            ProvIdentCur.Number = textIDNumber.Text;
            if (IsNew)
            {
                ProviderIdentity.Insert(ProvIdentCur);
            }
            else
            {
                ProviderIdentity.Update(ProvIdentCur);
            }
