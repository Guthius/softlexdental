...
namespace OpenDental
{
    ...
    public class FormDunningEdit : ODForm
    {
        ...
        private void FormDunningEdit_Load(object sender, System.EventArgs e)
        {
            ...
            if (!Security.CurrentUser.ClinicRestricted || _dunningCur.ClinicNum == 0)
            {
            ...
            for (int i = 0; i < _listClinics.Count; i++)
            {
                ...
                if (_listClinics[i].Id == _dunningCur.ClinicNum)
                {
        ...
        private void butOK_Click(object sender, System.EventArgs e)
        {
            ...
            _dunningCur.ClinicNum = _listClinics[comboClinics.SelectedIndex].Id;
