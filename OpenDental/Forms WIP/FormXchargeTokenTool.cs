...
namespace OpenDental {
	public partial class FormXchargeTokenTool:ODForm {
		...
		private void FormXchargeTokenTool_Load(object sender,EventArgs e) {
            ...
            //string paymentType=ProgramProperties.GetPropVal(prog.ProgramNum,"PaymentType",Clinics.ClinicId);
            ...
            //_xUsername=ProgramProperties.GetPropVal(prog.ProgramNum,"Username",Clinics.ClinicId);
            //_xPassword=ProgramProperties.GetPropVal(prog.ProgramNum,"Password",Clinics.ClinicId);
		...
		private void FilterCardList() {
            ...
            //	info.Arguments+="/USERID:"+ProgramProperties.GetPropVal(prog.ProgramNum,"Username",Clinics.ClinicId)+" ";
            //	info.Arguments+="/PASSWORD:"+CodeBase.MiscUtils.Decrypt(ProgramProperties.GetPropVal(prog.ProgramNum,"Password",Clinics.ClinicId))+" ";
