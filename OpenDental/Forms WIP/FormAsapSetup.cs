...
namespace OpenDental
{
    public partial class FormAsapSetup : ODForm
    {
        ...
        private void FillClinics()
        {
            ...
            {
                int addedIdx = comboClinic.Items.Add(new ComboClinicItem(listClinics[i].Abbr, listClinics[i].Id));
                if (listClinics[i].Id == Clinics.ClinicId)
                {
        ...
        private void checkUseDefaults_Click(object sender, EventArgs e)
        {
            ...
            {//Was checked, now user is unchecking it.
