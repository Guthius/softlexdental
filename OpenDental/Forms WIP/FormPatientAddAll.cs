...
namespace OpenDental
{
    public partial class FormPatientAddAll : ODForm
    {
        ...
        private void FormPatientAddAll_Load(object sender, EventArgs e)
        {
            ...
            if (Preference.GetBool(PreferenceName.ClinicAllowPatientsAtHeadquarters))
            {
            ...
            SetRequiredFields();
            _isLoad = false;
            Plugin.Trigger(this, "FormPatientAddAll_Loaded");
        }
            ...
            for (int i = 0; i < _listRequiredFields.Count; i++)
            {
                ...
                switch (_listRequiredFields[i].FieldName)
                {
                    ...
                    case RequiredFieldName.Clinic:
                        SetRequiredListControl(labelClinic, comboClinic1, areConditionsMet, 0, "Selection cannot be 'Unassigned'.");
                        SetRequiredListControl(labelClinic, comboClinic2, areConditionsMet, 0, "Selection cannot be 'Unassigned'.");
                        SetRequiredListControl(labelClinic, comboClinic3, areConditionsMet, 0, "Selection cannot be 'Unassigned'.");
                        SetRequiredListControl(labelClinic, comboClinic4, areConditionsMet, 0, "Selection cannot be 'Unassigned'.");
                        SetRequiredListControl(labelClinic, comboClinic5, areConditionsMet, 0, "Selection cannot be 'Unassigned'.");
                        break;
        ...
        private bool ConditionsAreMet(RequiredField reqField)
        {
            ...
            {//This RequiredField is always required
                return true;
            }
        ...
        {
            if (PIn.Bool(PreferenceName.AddFamilyInheritsEmail.ToString()))
            {
        ...
        private void FillComboBillTypes(ComboBox comboBox)
        {
            ...
            {
                comboBox.Items.Add(_listBillingTypeDefs[i].Description);
        ...
        private void FillReferredFrom()
        {
            ...
            for (int i = 1; i < firstRefFullName.Length + 1; i++)
        ...
        {
            if (lname == "" && fname == "")
            { //validation should prevent this from happening, but just in case.
        ...
        private void butOK_Click(object sender, EventArgs e)
        {
            ...
            if ((comboClinic1.SelectedIndex < 0 || comboClinic2.SelectedIndex < 0
            ...
            for (int i = 0; i < listPatsAdding.Count; i++)
            {//Check all the patients that we're trying to add.
            ...
            for (int i = 0; i < arrayPatsInFam.Length; i++)
            {
                ...
                switch (i)
                {
                    case 0://guarantor
                        ...
                        pat.ClinicNum = comboClinic1.SelectedTag<Clinic>().Id;
                    ...
                    case 1://patient 2
                        ...
                        pat.ClinicNum = comboClinic2.SelectedTag<Clinic>().Id;
                    ...
                    case 2://patient 3
                        ...
                        pat.ClinicNum = comboClinic3.SelectedTag<Clinic>().Id;
                    ...
                    case 3://patient 4
                        ...
                        pat.ClinicNum = comboClinic4.SelectedTag<Clinic>().Id;
                    ...
                    case 4://patient 5
                        ...
                        pat.ClinicNum = comboClinic5.SelectedTag<Clinic>().Id;
            ...
            if (insComplete1)
            {
                ...
                if (selectedPlan1 == null)
                {
                    ...
                    if (Preference.GetBool(PreferenceName.InsDefaultPPOpercent))
                    {
                        selectedPlan1.PlanType = "p";
                    }
                    if (selectedPlan1.PlanType == "" && Preference.GetBool(PreferenceName.InsDefaultShowUCRonClaims))
                    {
                        selectedPlan1.ClaimsUseUCR = true;
                    }
                    selectedPlan1.CobRule = (EnumCobRule)Preference.GetInt(PreferenceName.InsDefaultCobRule);
                ...
                sub1.AssignBen = Preference.GetBool(PreferenceName.InsDefaultAssignBen);
                sub1.ReleaseInfo = true;
                sub1.DateEffective = DateTime.MinValue;
                sub1.DateTerm = DateTime.MinValue;
                if (comboSubscriber1.SelectedIndex > 0)
                {//comboSubscriber has been validated to contain the same number of indexes as the family list
            ...
            if (insComplete2)
            {
                ...
                if (selectedPlan2 == null)
                {
                    ...
                    if (selectedPlan2.PlanType == "" && Preference.GetBool(PreferenceName.InsDefaultShowUCRonClaims))
                    {
                        selectedPlan2.ClaimsUseUCR = true;
                    }
                    selectedPlan2.CobRule = (EnumCobRule)Preference.GetInt(PreferenceName.InsDefaultCobRule);
                ...
                sub2.AssignBen = Preference.GetBool(PreferenceName.InsDefaultAssignBen);
            ...
            for (int i = 0; i < arrayPatsInFam.Length; i++)
            {//loop for each possible family member. Position 0 is the guarantor and is required but all others could be null
                ...
                switch (i)
                {
                    case 0://guarantor, 1st adult
                        if (insComplete1 && checkInsOne1.Checked)
                        {
                            ...
                            if (checkInsTwo1.Checked && comboSubscriber1.SelectedIndex != 1 && comboSubscriber2.SelectedIndex == 1)
                            {//both combo boxes contain 'none'
                                patplan1.Ordinal = 2;
                            }
