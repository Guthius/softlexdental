...
namespace OpenDental
{
    ...
    public class FormUAppoint : ODForm
    {
        ...
        private void FillForm()
        {
            ...
            textPath.Text = ProgramPreference.GetString(ProgramCur.Id, ProgramPreferenceName.ProgramPath);
        ...
        private static void ThreadStartTarget(object data)
        {
            ...
            DateTime dateTimeLastUploaded = PIn.DateT(ProgramProperties.GetPropVal(prog.Id, "DateTimeLastUploaded"));
            //track delta here
            ...
            string serverName = ProgramPreference.GetString(prog.Id, ProgramPreferenceName.ProgramPath);
        ...
        private bool SaveToDb()
        {
            ...
            ProgramPreference.Set(ProgramCur.Id, ProgramPreferenceName.ProgramPath, textPath.Text);
