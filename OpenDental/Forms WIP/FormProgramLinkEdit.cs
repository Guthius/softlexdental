...
namespace OpenDental
{
    ...
    public class FormProgramLinkEdit : ODForm
    {
        ...
        {
            ProgramPreference progProp = (ProgramPreference)gridMain.Rows[e.Row].Tag;
        ...
        private void PropertyTypeDirector(ProgramPreference prop)
        {
        ...
        private void butDelete_Click(object sender, System.EventArgs e)
        {
            ...
            if (MessageBox.Show("Delete this program link?", "", MessageBoxButtons.OKCancel)
                != DialogResult.OK)
            {
                return;
            }
