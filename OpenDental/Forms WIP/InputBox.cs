...
namespace OpenDental
{
    ...
    /// </summary>
    public class InputBox : FormBase
    {
        ...
        /// <summary>
        /// Returns the text that was entered in the textboxes. Will be in the order they were passed into the constructor.
        /// </summary>
        ...
        /// <summary>
        /// Creates a textbox with a label containing the given prompt.
        /// </summary>
        public InputBox(string prompt) : this(prompt, false)
        {
        }

        /// <summary>
        /// Creates a textbox with a label containing the given prompt, with a default string in the text field.
        /// </summary>
        public InputBox(string prompt, string defaultText) : this(prompt, false, defaultText, Size.Empty)
        {
        ...
        /// <summary>
        /// This constructor allows a list of strings to be sent in and fill a comboBox for users to select from.
        /// </summary>
        public InputBox(string prompt, List<string> listSelections) : this(prompt, listSelections, false)
        {
        }
        ...
        /// <summary>
        /// Use this constructor to create multiple input controls.
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.labelPrompt.Location = new System.Drawing.Point(13, 16);
            this.labelPrompt.Name = "labelPrompt";
            this.labelPrompt.Size = new System.Drawing.Size(427, 112);
    ...
    "Checkboxes.";
            ...
            this.butOK.Location = new System.Drawing.Point(214, 131);
            ...
            this.butCancel.Location = new System.Drawing.Point(330, 131);
            ...
            this.butDelete.Location = new System.Drawing.Point(13, 131);
        ...
        private void AddInputControls()
        {
            ...
            int curLocationY = Padding.Top;
            int controlWidth = ClientSize.Width - Padding.Horizontal;
            int minWidth = 250;
            int posX = 32;
            int itemOrder = 1;
            foreach (InputBoxParam inputParam in _listInputParams)
            {
                ...
                switch (inputParam.ParamType)
                {
                    ...
                    case InputBoxType.CheckBox:
                        ...
                        curLocationY += checkBox.Size.Height + 2 + inputParam.Position.Y;
                        break;
    ...
    public class InputBoxParam
    {
        ...
        /// <summary>
        /// If InputBoxType = ComboSelect or ComboMultiSelect, listComboSelections will be the items in the combobox.
        /// If InputBoxType = TextBox or TextBoxMultiLine, textBoxText will be the default text in that text box.
        /// </summary>
        public InputBoxParam(InputBoxType paramType, string labelText, List<string> listComboSelections = null, string text = null, List<int> listSelectedIndices = null)
        {
            LabelText = labelText;
            ParamType = paramType;
