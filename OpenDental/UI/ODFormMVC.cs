...
namespace OpenDental {
	///<summary>A few MVC-style OD forms extend this class. It fulfills an explicit MVC relationship for the extending class.
	///This class is a sibling to ODForm. It does help and signal processing in addition to MVC.
	...
	public class ODFormMVC<M,V,C> : ODViewAbs<M,V,C,Signalod>, ISignalProcessor where M : ODModelAbs<M> where C : ODControllerAbs<V> {
		...
		protected override void ShowHelp(string name) {
			try {
