...
namespace OpenDental.UI {
	...
	public partial class SignatureBoxWrapper:UserControl {
		...
		public void SetAllowDigitalSig(bool allowDigitalSig) {
			butESign.Visible=allowDigitalSig && Preference.GetBool(PreferenceName.SignatureAllowDigital);
		}
		...
		private void butESign_Click(object sender,EventArgs e) {
			...
			Provider provCur=Providers.GetProv(curUser.ProviderId.GetValueOrDefault());
