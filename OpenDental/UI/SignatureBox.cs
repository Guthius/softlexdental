...
{
    /// <summary>
    /// This class is specifically designed to duplicate the functionality of the Topaz SigPlusNET control. 
    /// So even if I would have done it differenly, I didn't have a choice. 
    /// Size of box will always be 362,79, although that seems to be arbitrary. 
    /// We just don't want to be changing it.
    /// </summary>
    public partial class SignatureBox : Control
    {
        ...
        /// <summary>
        /// Initializes a new instance of he <see cref="SignatureBox"/> class.
        /// </summary>
        public SignatureBox()
        {
            InitializeComponent();
        ...
        /// <summary>
        /// Gets or sets the state of the tablet.
        /// </summary>
        public int TabletState
        {
            get => tabletState;
            set => tabletState = value;
        }
        ...
        public int NumberOfTabletPoints() => pointList.Count;

        /// <summary>
        /// Set it to "0000000000000000" (16 zeros) to indicate no key string to be used for encryption.
        /// Use this OR SetAutoKeyData.
        /// </summary>
        ...
        /// <summary>
        /// The data that's begin signed.
        /// A 16 byte hash will be created off this data, and used to encrypt the signature.
        /// Use this OR SetKeyString.
        /// But once the choice is made for a particular data type, it may never be changed.
        /// </summary>
