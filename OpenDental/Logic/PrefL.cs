...
namespace OpenDental
{
    public class PrefL
    {
        ...
        /// It returns true if either no conversion is necessary, or if conversion was successful.
        /// False for other situations like corrupt db, trying to convert to older version, etc. 
        /// Silent mode is mostly used from internal tools. 
        /// It is currently used in the Main Program if the silent command line argument is set.
        /// </summary>
        public static bool ConvertDB(bool silent, Form currentForm, bool useDynamicMode)
        {
            // TODO: This needs to be changed...

            //try
            //{
            //    var databaseVersion = new Version(PrefC.GetString(PrefName.DataBaseVersion));
            //
            //    if (databaseVersion < new Version(Application.ProductVersion))
            //    {
            //        return true;
            //    }
            //}
