...
namespace OpenDental
{
    public class PrinterL
    {
        ...
        ///<param name="printoutOrientation">Defaults to printers default value.  Otherwise specify a value for either landscape or portrait.</param>
        ///<returns>Returns true if succesfully printed, or if preview is shown and OK is clicked.</returns>
        public static bool TryPrintOrDebugClassicPreview(PrintPageEventHandler printPageHandler, string auditDescription, Margins margins = null
        ...
        public static bool TryPrint(PrintPageEventHandler printPageHandler, string auditDescription = "", long auditPatNum = 0
        ...
        private static void ShowError(string messageOverride = null, Exception exception = null)
        {
        ...
        {
            if (printout.SettingsErrorCode != PrintoutErrorCode.Success)
            {//Mimics how preview form handles errors.
                ShowError(printout);
                return false;
            }
        ...
        /// <summary>
        ///     <para>
        ///         Opens a print preview dialog for the specified <paramref name="printout"/>.
        ///         Returns true if dialog result was <see cref="DialogResult.OK"/>; otherwise 
        ///         returns false.
        ///     </para>
        /// </summary>
        /// <param name="printout">The printout to preview.</param>
        /// <returns>
        ///     True if the dialog result of the print preview dialog was 
        ///     <see cref="DialogResult.OK"/>; otherwise, false.
        /// </returns>
        private static bool RpPreview(ODprintout printout)
        {
            ...
            using (var formRpPrintPreview = new FormRpPrintPreview(printout))
            {
                if (formRpPrintPreview.ShowDialog() == DialogResult.OK)
                {
                    return true;
                }
            }
        ...
        ///     </para>
        ///     <para>
        ///         Uses the classic preview dialog. New code should use the 
        ///         <see cref="RpPreview"/> method instead of this one.
        ///     </para>
        /// </summary>
        /// <param name="printout">The printout to preview.</param>
        /// <returns>
