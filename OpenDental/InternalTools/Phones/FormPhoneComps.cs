...
namespace OpenDental {
	public partial class FormPhoneComps:ODForm {
		...
		private void FillMain() {
			...
			gridMain.Columns.Add(new ODGridColumn("Ext",-1, sortingStrategy: ODGridSortingStrategy.AmountParse, isEditable: true));
			gridMain.Columns.Add(new ODGridColumn("CompName",-2));
			gridMain.Rows.Clear();
			ODGridRow row;
