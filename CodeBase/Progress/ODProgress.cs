...
namespace CodeBase
{
    ...
    public class ODProgress
    {
        ...
        ///<summary>Used for keeping track of active progress windows.  Multiple progress windows can be shown at the same time.
        ///E.g. FormOpenDental will show the Splash progress window while the ClassConvertDatabases progress window spins in front.</summary>
