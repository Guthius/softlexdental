...
namespace CodeBase
{
    public class ProgressBarHelper
    {
        ...
        public string PercentValue { get; }
        ...
        public ProgBarStyle ProgressStyle { get; set; }

        ///<summary>Indicates what event this progress bar helper represents.  Used heavily by FormProgressExtended.</summary>
        public ProgBarEventType ProgressBarEventType { get; set; }

        ///<summary>Changes progress bar marquee speed</summary>
        public int MarqueeSpeed { get; }

        public string LabelTop { get; }

        public bool IsValHidden { get; }

        public bool IsTopHidden { get; }

        public bool IsPercentHidden { get; }

        ///<summary>Used as a shell to store information events need to update a progress window.</summary>
        public ProgressBarHelper(
            string labelValue, string percentValue = "", int blockValue = 0, int blockMax = 0, 
            ProgBarStyle progressStyle = ProgBarStyle.NoneSpecified, string tagString = "", 
            int marqueeSpeed = 0, string labelTop = "", bool isLeftValHidden = false, 
            bool isTopHidden = false, bool isPercentHidden = false, 
            ProgBarEventType progressBarEventType = ProgBarEventType.ProgressBar)
        {
