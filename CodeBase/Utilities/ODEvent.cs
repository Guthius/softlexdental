namespace CodeBase
{
    ...
    {
        /// <summary>
        /// Occurs when any developer calls Fire(). Can happen from anywhere in the program.
    ...
    {
        /// <summary>
        /// A generic object related to the event, such as a Commlog object. Can be null.
        /// </summary>
        public object Tag { get; }

        /// <summary>
        /// Used to uniquly identify this ODEvent for consumers.  And event type of Undefined will be treated as a generic ODEvent.
        /// </summary>
        ...
        /// </summary>
        ///<param name="eventType">Progress windows registered to this ODEventType will consume this event arg and act upon the tag accordingly.An event type of Undefined will be treated as a generic ODEvent.</param>
    ...
    public enum ODEventType
    {
        ...
        FormClaimSend_GoTo,
        ///<summary>23 - Events that occurs during the loading of FormOpenDental while the splash screen is showing.</summary>
