...
namespace CodeBase {
	...
	public class ODprintout {
		...
		public ODprintout(PrintPageEventHandler printPageHandler=null,PrintSituation printSit=PrintSituation.Default,long auditPatNum=0,string auditDescription=""
			...
			,Duplex duplex=Duplex.Default,short copies=1,int totalPages=1) : base()
		{
			...
			_printDoc.PrintPage+=printPageHandler;
