...
namespace CodeBase
{
    ...
    {
        /// <summary>
        /// [CurrentDirectory]/InstallUtil/installutil.exe
        /// </summary>
        ...
        public static bool CreateServiceConfigFile(string filePath, string serverName, string databaseName, string mySqlUser, string mySqlPass, string mySqlPassHash, string mySqlUserLow = "", string mySqlUserPassLow = "")
        {
        ...
        public static bool HasService(string serviceName, string servicePath)
        {
            ...
            if (asWmi.Any(x => string.Compare(x.Name, serviceName, true) == 0))
            ...
            if (servicePath != null && asWmi.Any(x => x.PathName.ToLower().Contains(servicePath.ToLower())))
            { //Path match. Already exists.
                return true;
            }
